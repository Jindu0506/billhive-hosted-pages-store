(function(){"use strict";const f={baseUrl:"http://localhost:4001",endpoints:{pricingTable:l=>`/products/${l}/pricing-table`,products:"/products",subscriptions:"/subscriptions"},headers:{"Content-Type":"application/json",Accept:"application/json"},getAuthHeaders(){return{...this.headers,"api-key":this.apiKey}},getPricingTableUrl(l=null){const e=l||this.productId;return`${this.baseUrl}${this.endpoints.pricingTable(e)}`}};typeof module<"u"&&module.exports&&(module.exports=f),typeof window<"u"&&(window.ApiConfig=f);function w(l,e=null){let t="";switch(console.log("generateThemeCSS :",l),e){case"Pricing-Table":return l.branding&&(l.branding.primaryColor&&(t+=`--billhive-primary-color: ${l.branding.primaryColor};
  ...
  `}function C(l){if(console.log("Merging themes. Custom theme:",l),!l)throw new Error("mergeThemes: customTheme is required and cannot be null or undefined");if(!l.theme)throw new Error('mergeThemes: customTheme must have a "theme" property containing colors, typography, and shadows');if(!l.theme.colors)throw new Error("mergeThemes: theme.colors section is required");if(!l.theme.typography)throw new Error("mergeThemes: theme.typography section is required");if(["accent","text"].forEach(i=>{if(!l.theme.colors[i])throw new Error(`mergeThemes: Required color property missing: theme.colors.${i}`)}),!l.theme.typography.fontFamily)throw new Error("mergeThemes: Required typography property missing: theme.typography.fontFamily");const t=JSON.parse(JSON.stringify(l));return console.log("Processed theme:",t),t}function y(l){let e=l.replace("#","");e.length===8&&(e=e.substr(0,6));const t=parseInt(e.substr(0,2),16),i=parseInt(e.substr(2,2),16),o=parseInt(e.substr(4,2),16),a=Math.floor(t*.8),s=Math.floor(i*.8),n=Math.floor(o*.8);return{theme:{colors:{accentHover:`#${a.toString(16).padStart(2,"0")}${s.toString(16).padStart(2,"0")}${n.toString(16).padStart(2,"0")}`,accentLight:`rgba(${t}, ${i}, ${o}, 0.1)`},shadows:{button:`0 2px 4px rgba(${t}, ${i}, ${o}, 0.3)`}}}}function k(l){if(!l)throw new Error("validateTheme: theme is required and cannot be null or undefined");if(!l.theme)throw new Error('validateTheme: Theme must have a "theme" property containing colors, typography, and shadows');const e=l.theme;if(!e.colors)throw new Error("validateTheme: Missing theme.colors section");if(["accent","text"].forEach(o=>{if(!e.colors[o])throw new Error(`validateTheme: Missing required color property: theme.colors.${o}`)}),Object.entries(e.colors).forEach(([o,a])=>{if(a&&typeof a=="string"&&!a.match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{3})|rgba?\(.*\)$/))throw new Error(`validateTheme: Invalid color format for theme.colors.${o}: ${a}`)}),!e.typography)throw new Error("validateTheme: Missing theme.typography section");if(["fontFamily"].forEach(o=>{if(!e.typography[o])throw new Error(`validateTheme: Missing required typography property: theme.typography.${o}`)}),l.layout&&!["in-app","full-page"].includes(l.layout))throw new Error(`validateTheme: Invalid layout value: ${l.layout}. Must be 'in-app' or 'full-page'`)}class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.selectedPlan=null,this.productId=null,this.planId=null,this.apiKey=null,this.isLoadingPlan=!1,this.planLoadError=null,this.addons=[],this.selectedAddons=new Set,this.addonQuantities=new Map,this.isLoadingAddons=!1,this.addonsLoadError=null,this.isVisible=!1,this.couponCode="",this.appliedCoupon=null,this.availableDiscounts=[],this.selectedDiscount=null,this.isLoadingOffers=!1,this.offersLoadError=null,this.updateTimeout=null,this.orderEstimate=null,this.isLoadingEstimate=!1,this.estimateError=null,this.estimateRequestId=0,this.currentModalStep="plan-selection",this.existingAccount=null,this.isCheckingExistingAccount=!1,this.createdOrder=null,this.isCreatingOrder=!1,this.orderCreated=!1,this.orderInvoices=[],this.isLoadingInvoices=!1,this.personalDetails={firstName:"",lastName:"",email:"",phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},this.formErrors={},this.selectedPaymentMethod="",this.orderData=null,this.paymentDetails={card:{cardNumber:"",expiryDate:"",cvv:"",cardholderName:""},upi:{upiId:""},netbanking:{bankName:""},wallet:{walletType:"",walletNumber:""}},this.theme={},this.cashfreeInstance=null,this.cashfreeComponents={cardNumber:null,cardHolder:null,cardExpiry:null,cardCvv:null,upiCollect:null,wallets:new Map},this.preview=!1}get themeData(){return this.theme}set themeData(e){e&&typeof e=="object"&&this.applyThemeData(e)}applyThemeData(e){var t,i;try{const o=k(e);if(o.isValid){this.theme=C(e);const a=((i=(t=e.theme)==null?void 0:t.colors)==null?void 0:i.accent)||e.accentColor;if(a){const s=y(a);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...s.theme.colors},shadows:{...this.theme.theme.shadows,...s.theme.shadows}}}}console.log("Checkout programmatic theme applied:",this.theme),this.render()}else console.warn("Invalid themeData configuration:",o.errors)}catch(o){console.warn("Error applying themeData:",o)}}static get observedAttributes(){return["product-id","data-plan-id","api-key","visible","data-theme","preview"]}connectedCallback(){this.loadData(),this.loadCashfreeSDK(),this.setupEventListeners()}async loadCashfreeSDK(){try{if(window.Cashfree){console.log("Cashfree SDK already loaded globally"),this.cashfreeInstance=window.Cashfree;return}const e=document.createElement("script");e.src="https://sdk.cashfree.com/js/v3/cashfree.js",e.async=!0,await new Promise((t,i)=>{e.onload=()=>{console.log("Cashfree SDK script loaded"),window.Cashfree?(this.cashfreeInstance=new window.Cashfree({mode:"sandbox"}),console.log("✅ Cashfree SDK initialized successfully"),t()):i(new Error("Cashfree object not found after script load"))},e.onerror=i,document.head.appendChild(e)})}catch(e){console.error("❌ Failed to load Cashfree SDK:",e)}}attributeChangedCallback(e,t,i){t!==i&&(e==="product-id"?this.productId=i:e==="data-plan-id"?this.planId=i:e==="api-key"?this.apiKey=i:e==="visible"?(this.isVisible=i==="true",this.isVisible&&this.render()):e==="data-theme"?(this.loadTheme(),this.render()):e==="preview"&&(this.preview=i==="true"))}loadData(){this.productId=this.getAttribute("product-id"),this.planId=this.getAttribute("data-plan-id"),this.apiKey=this.getAttribute("api-key"),this.planId||(this.addons=[],this.selectedPlan=null),this.isVisible=this.getAttribute("visible")==="true",this.loadTheme()}loadTheme(){var i,o,a,s;this.theme={};const e=((o=(i=this.theme.theme)==null?void 0:i.colors)==null?void 0:o.accent)||this.theme.accentColor;if(e){const n=y(e);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...n.theme.colors},shadows:{...this.theme.theme.shadows,...n.theme.shadows}}}}console.log("Checkout theme loaded:",this.theme);const t=this.getAttribute("data-theme");if(console.log("themeAtr :",t),t)try{const n=JSON.parse(t),d=k(n);if(d.isValid){this.theme=C(n);const c=((s=(a=n.theme)==null?void 0:a.colors)==null?void 0:s.accent)||n.accentColor;if(c){const r=y(c);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...r.theme.colors},shadows:{...this.theme.theme.shadows,...r.theme.shadows}}}}console.log("Checkout custom theme applied:",this.theme)}else console.warn("Invalid theme configuration:",d.errors)}catch(n){console.warn("Invalid JSON in data-theme attribute:",n)}}loadPlan(){this.selectedPlan=null}async loadPlanFromApi(){var e;if(this.planId&&!this.preview){this.isLoadingPlan=!0,this.planLoadError=null;try{const i=`${((e=window.ApiConfig)==null?void 0:e.baseUrl)||f.baseUrl}/rate-plan-prices/${this.planId}`,o=await fetch(i,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!o.ok)throw new Error(`HTTP error! status: ${o.status}`);const a=await o.json();this.selectedPlan=this.transformPlanApiData(a),this.isLoadingPlan=!1,this.planLoadError=null,this.render(),this.loadAddonsFromApi().catch(s=>{console.error("Failed to load addons:",s)}),this.loadApplicableOffers().catch(s=>{console.error("Failed to load applicable offers:",s)}),this.updateOrderSummary()}catch(t){this.planLoadError=t.message,this.isLoadingPlan=!1,this.isLoadingAddons=!1,this.loadPlan(),this.addons=[],this.render()}}}transformPlanApiData(e){var i,o,a;return{id:e.ratePlanId,ratePlanPriceId:e.ratePlanPriceId,name:e.name||e.externalName,description:e.description,price:e.price,currencyCode:e.currencyCode,period:((i=e.billingPeriod)==null?void 0:i.periodName)||((o=e.billingPeriod)==null?void 0:o.period),periodName:(a=e.billingPeriod)==null?void 0:a.periodName,billingPeriod:e.billingPeriod,features:e.addons||e.features||[],recommended:e.mostPopular||!1,planLevel:e.planLevel,isTrial:e.isTrial,trialPeriod:e.trialPeriod,ratePlanKey:e.ratePlanKey,productName:e.productName,productId:e.productId,status:e.status,isVisibleInPortal:e.isVisibleInPortal,isVisibleInCheckout:e.isVisibleInCheckout,requireBillingAtSignup:e.requireBillingAtSignup,autoRenew:e.autoRenew,termLength:e.termLength,taxIncluded:e.taxIncluded,pricingModel:e.pricingModel,billingCycle:e.billingCycle}}async loadAddonsFromApi(){var e,t;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){this.addons=[];return}if(!this.preview){this.isLoadingAddons=!0,this.addonsLoadError=null;try{const i=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,o=encodeURIComponent('{"where":{"applicability":{"neq":"Mandatory"}}}'),a=`${i}/rate-plan-prices/${this.selectedPlan.ratePlanPriceId}/addons?filter=${o}`,s=await fetch(a,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!s.ok)throw new Error(`Failed to fetch addons: HTTP ${s.status}`);const n=await s.json();this.addons=this.transformAddonsApiData(n),this.isLoadingAddons=!1,this.addonsLoadError=null,this.render()}catch(i){console.error("Error loading addons:",i),this.addonsLoadError=i.message,this.isLoadingAddons=!1,this.addons=[],this.render()}}}transformAddonsApiData(e){return Array.isArray(e)?e.map(t=>{var i,o;return{id:t.addonPriceId,addonId:t.addonId,addonPriceId:t.addonPriceId,name:t.externalName||t.name,description:t.description,price:t.price,quantity:t.quantity||1,unitOfMeasurement:t.unitOfMeasurement,period:(o=(i=t.billingPeriod)==null?void 0:i.periodName)==null?void 0:o.toLowerCase(),billingPeriod:t.billingPeriod,currencyCode:t.currencyCode,pricingModel:t.pricingModel,applicability:t.applicability,isPriceIncluded:t.isPriceIncluded,isVisibleInPortal:t.isVisibleInPortal,status:t.status,addonPriceKey:t.addonPriceKey}}):[]}async loadApplicableOffers(){var e,t;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){console.warn("No ratePlanPriceId available to load offers"),this.availableDiscounts=[];return}if(this.preview){this.availableDiscounts=[],this.isLoadingOffers=!1,this.render();return}this.isLoadingOffers=!0,this.offersLoadError=null,this.render();try{const o=`${((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl}/applicable-offers`,a=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify({ratePlanPriceId:this.selectedPlan.ratePlanPriceId})});if(!a.ok)throw new Error(`Failed to fetch applicable offers: HTTP ${a.status}`);const s=await a.json();this.availableDiscounts=s.map(n=>{var d;return{id:n.id,name:n.externalName||n.name,description:n.description,type:n.discountType==="Percentage"?"percentage":"fixed",value:n.amount,code:((d=n.code)==null?void 0:d.trim())||`OFFER${n.id.slice(-8).toUpperCase()}`,apiData:{tenantId:n.tenantId,applyOn:n.applyOn,discountDurationType:n.discountDurationType,expiryDate:n.expiryDate,maxRedemptionCount:n.maxRedemptionCount,maxRedemptionCountPerCustomer:n.maxRedemptionCountPerCustomer,minimumPurchaseAmount:n.minimumPurchaseAmount,status:n.status}}}).filter(n=>n.apiData.status==="Active"),this.isLoadingOffers=!1,this.offersLoadError=null}catch(i){console.error("Error loading applicable offers:",i),this.isLoadingOffers=!1,this.offersLoadError=i.message,this.availableDiscounts=[]}this.render()}async loadOrderEstimate(){var t;this.estimateRequestId+=1;const e=this.estimateRequestId;if(this.isLoadingEstimate=!0,this.estimateError=null,this.orderEstimate=null,this.render(),this.preview){this.orderEstimate={subtotal:99.99,tax:9.99,total:109.98,currency:"USD",items:[]},this.isLoadingEstimate=!1,this.render();return}try{const o=`${((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl}/orders/estimate`,a=this.buildEstimateRequestBody(),s=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify(a)});if(e!==this.estimateRequestId)return;if(!s.ok)throw new Error(`Failed to fetch order estimate: HTTP ${s.status}`);const n=await s.json();console.log("Order estimate received:",n),e===this.estimateRequestId&&(this.orderEstimate=n,this.isLoadingEstimate=!1,this.estimateError=null)}catch(i){e===this.estimateRequestId&&(console.error("Error loading order estimate:",i),this.isLoadingEstimate=!1,this.estimateError=i.message,this.orderEstimate=null)}e===this.estimateRequestId&&this.render()}buildEstimateRequestBody(){var o;const e=[],t=new Date().toISOString().split("T")[0];return this.selectedPlan&&(e.push({itemType:"Rate Plan",itemId:this.selectedPlan.ratePlanPriceId,quantity:1,options:{startDate:t,billingCycle:1,autoRenew:!1,autoCollect:!1,invoiceGenerationPreference:"Immediately"}}),this.selectedAddons.forEach(a=>{const s=this.addons.find(n=>n.id===a);s&&e.push({itemType:"Addon",itemId:s.addonPriceId,quantity:this.addonQuantities.get(a)||1,options:{ratePlanPriceId:this.selectedPlan.ratePlanPriceId}})})),this.selectedDiscount&&e.push({itemType:"Discount",itemId:this.selectedDiscount.id,quantity:1}),console.log("Applied coupon is:",this.appliedCoupon),this.appliedCoupon&&e.push({itemType:"Coupon",itemId:this.appliedCoupon.code,quantity:1,options:{startDate:t}}),{srcSysCode:"Website",eventType:"NEW SUBSCRIPTION",currency:(o=this.selectedPlan)==null?void 0:o.currencyCode,scheduleDate:t,cart:e,personalInfo:{}}}buildPlaceOrderRequestBody(e){const t=this.buildEstimateRequestBody();return t.personalInfo={accountId:e},t}async placeOrder(e){var t,i;if(this.orderCreated)return console.log("Order already created, skipping duplicate creation"),this.createdOrder;if(this.isCreatingOrder){console.log("Order creation in progress, skipping duplicate request");return}if(this.preview){const o={orderId:"preview-order-id",orderNumber:"ORD-PREVIEW-001",accountId:e,status:"Draft",totalAmount:((t=this.orderEstimate)==null?void 0:t.total)||0};return this.createdOrder=o,this.orderCreated=!0,o}try{this.isCreatingOrder=!0;const a=`${((i=window.ApiConfig)==null?void 0:i.baseUrl)||f.baseUrl}/orders/place`,s=this.buildPlaceOrderRequestBody(e);console.log("Placing order with request body:",s);const n=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify(s)});if(!n.ok)throw new Error(`Failed to place order: HTTP ${n.status}`);const d=await n.json();return console.log("Order placed successfully:",d),this.createdOrder=d,this.orderCreated=!0,this.isCreatingOrder=!1,d}catch(o){throw console.error("Error placing order:",o),this.isCreatingOrder=!1,o}}async getOrderInvoices(e){var t,i;if(!e){console.error("Order ID is required to fetch invoices");return}if(this.isLoadingInvoices){console.log("Invoices loading in progress, skipping duplicate request");return}if(this.preview)return this.orderInvoices=[{invoiceId:"preview-invoice-id",invoiceNumber:"INV-PREVIEW-001",amount:((t=this.orderEstimate)==null?void 0:t.total)||109.98,status:"Posted"}],this.isLoadingInvoices=!1,this.render(),this.orderInvoices;try{this.isLoadingInvoices=!0;const o=((i=window.ApiConfig)==null?void 0:i.baseUrl)||f.baseUrl,a=encodeURIComponent(JSON.stringify({where:{status:"Posted",orderId:e}})),s=`${o}/invoices?filter=${a}`;console.log("Fetching invoices for order:",e);const n=await fetch(s,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!n.ok)throw new Error(`Failed to fetch invoices: HTTP ${n.status}`);const d=await n.json();return console.log("Invoices fetched successfully:",d),this.orderInvoices=d,this.isLoadingInvoices=!1,d}catch(o){throw console.error("Error fetching invoices:",o),this.isLoadingInvoices=!1,this.orderInvoices=[],o}}async updateAccount(e){var t,i,o;try{const s=`${((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl}/accounts/${e}`,n={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1},d=await fetch(s,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify(n)});if(!d.ok)throw new Error(`Failed to update account: HTTP ${d.status}`);let c;return d.status===204?(console.log("Customer account updated successfully (204 No Content)"),c={...this.existingAccount,accountId:e,name:n.name,country:n.country,address:n.address,state:n.state,city:n.city,zipCode:n.zipCode,phone:n.phone,email:n.email,accountType:n.accountType,communicationProfile:this.existingAccount.communicationProfile}):(c=await d.json(),console.log("Customer account updated:",c)),n.accountType==="Organisation"&&((o=(i=this.existingAccount)==null?void 0:i.communicationProfile)!=null&&o.contactId)&&await this.updateContact(e,this.existingAccount.communicationProfile.contactId),c}catch(a){throw console.error("Error updating account:",a),a}}async updateContact(e,t){var i,o,a,s,n;try{const c=`${((i=window.ApiConfig)==null?void 0:i.baseUrl)||f.baseUrl}/accounts/${e}/contacts/${t}`,r={fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,email:this.personalDetails.email,address:this.personalDetails.address.addressLine,billNotification:(a=(o=this.existingAccount)==null?void 0:o.communicationProfile)==null?void 0:a.billNotification,accountNotification:(n=(s=this.existingAccount)==null?void 0:s.communicationProfile)==null?void 0:n.accountNotification,phone:this.personalDetails.phone};console.log("Updating contact:",t,r);const p=await fetch(c,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify(r)});if(!p.ok)throw new Error(`Failed to update contact: HTTP ${p.status}`);if(p.status===204)return console.log("Contact updated successfully (204 No Content)"),{success:!0};const m=await p.json();return console.log("Contact updated:",m),m}catch(d){throw console.error("Error updating contact:",d),d}}async createCustomerAccount(){var e;if(this.preview)return{accountId:"preview-account-id",id:"preview-account-id",name:this.personalDetails.company||`${this.personalDetails.firstName} ${this.personalDetails.lastName}`,email:this.personalDetails.email};try{if(this.existingAccount&&this.existingAccount.accountId){console.log("Updating existing Draft account:",this.existingAccount);const n=await this.updateAccount(this.existingAccount.accountId);return this.createdAccountId=n.id||n.accountId,n}const i=`${((e=window.ApiConfig)==null?void 0:e.baseUrl)||f.baseUrl}/accounts`,o={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1,communicationProfile:{fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),address:this.personalDetails.address.addressLine,country:this.personalDetails.address.country,phone:this.personalDetails.phone,email:this.personalDetails.email}},a=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey},body:JSON.stringify(o)});if(!a.ok)throw new Error(`Failed to create customer account: HTTP ${a.status}`);const s=await a.json();return console.log("Customer account created:",s),this.createdAccountId=s.accountId,s}catch(t){throw console.error("Error creating customer account:",t),t}}async checkExistingAccount(e){var t;if(this.preview)return null;try{const o=`${((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl}/accounts?filter=${encodeURIComponent(JSON.stringify({where:{email:e}}))}`,a=await fetch(o,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!a.ok)throw new Error(`Failed to check existing account: HTTP ${a.status}`);const s=await a.json();return console.log("Existing account check result:",s),s.accounts&&s.accounts.length>0?s.accounts[0]:null}catch(i){return console.error("Error checking existing account:",i),null}}async handleEmailCheck(e){if(console.log("Checking email:",e),this.isCheckingExistingAccount){console.log("Already checking, skipping...");return}this.isCheckingExistingAccount=!0,this.existingAccount=null,this.hideExistingAccountMessage(),delete this.formErrors.email,this.updateFieldError("email");try{const t=await this.checkExistingAccount(e);console.log("Found existing account:",t),t&&t.accountId?t.status==="Active"?(console.log("Account is Active, showing error"),this.formErrors.email="Email ID is already associated with another account, please use another email ID",this.updateFieldError("email"),this.updateNextButtonState()):t.status==="Draft"&&(console.log("Account is Draft, prefilling details"),t&&(this.existingAccount=t,this.showExistingAccountMessage(t),await this.prefillAccountDetails(t))):(console.log("No existing account found"),this.hideExistingAccountMessage())}catch(t){console.error("Error during email check:",t)}finally{this.isCheckingExistingAccount=!1}}async prefillAccountDetails(e){console.log("Prefilling account details:",e),console.log("Current personal details before prefill:",this.personalDetails);const t=this.personalDetails.email;if(this.personalDetails={firstName:"",lastName:"",email:t,phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},e.accountType==="Organisation"){if(console.log("Organisation account detected"),this.personalDetails.company=e.name,console.log("Prefilled company:",this.personalDetails.company),e.communicationProfile&&e.communicationProfile.fullName){const i=e.communicationProfile.fullName.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName from communicationProfile:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName from communicationProfile:",this.personalDetails.lastName))}}else if(console.log("Individual account detected"),e.name){const i=e.name.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName:",this.personalDetails.lastName))}e.phone&&(this.personalDetails.phone=e.phone,console.log("Prefilled phone:",this.personalDetails.phone)),e.address&&(this.personalDetails.address.addressLine=e.address,console.log("Prefilled addressLine:",this.personalDetails.address.addressLine)),e.city&&(this.personalDetails.address.city=e.city,console.log("Prefilled city:",this.personalDetails.address.city)),e.state&&(this.personalDetails.address.state=e.state,console.log("Prefilled state:",this.personalDetails.address.state)),e.zipCode&&(this.personalDetails.address.zipCode=e.zipCode,console.log("Prefilled zipCode:",this.personalDetails.address.zipCode)),e.country&&(this.personalDetails.address.country=e.country,console.log("Prefilled country:",this.personalDetails.address.country)),console.log("Personal details after prefill:",this.personalDetails),this.render(),this.updateNextButtonState()}showExistingAccountMessage(e){const t=this.shadowRoot.querySelector('[data-field="email"]');if(t){let i=this.shadowRoot.querySelector(".existing-account-message");i||(i=document.createElement("div"),i.className="existing-account-message",t.parentNode.appendChild(i)),i.innerHTML=`
    ...
    `}getCurrencySymbol(e){return{USD:"$",EUR:"€",GBP:"£",INR:"₹",JPY:"¥",CNY:"¥",AUD:"A$",CAD:"C$",CHF:"Fr",SEK:"kr",NZD:"NZ$"}[e]||e||"$"}formatDisplayDate(e){if(!e)return"";try{return new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}catch(t){return console.error("Error formatting date:",t),e}}isCouponRejected(){return!this.orderEstimate||!this.orderEstimate.cart?!1:this.orderEstimate.cart.some(e=>{var i,o;return(e.itemType==="Discount"||e.itemType==="Coupon"||((i=e.description)==null?void 0:i.toLowerCase().includes("coupon"))||((o=e.description)==null?void 0:o.toLowerCase().includes("discount")))&&e.status==="Rejected"})}getCouponStatusMessage(){var t;if(!this.orderEstimate||!this.orderEstimate.cart)return"";const e=this.orderEstimate.cart.find(i=>{var a,s;return(i.itemType==="Discount"||i.itemType==="Coupon"||((a=i.description)==null?void 0:a.toLowerCase().includes("coupon"))||((s=i.description)==null?void 0:s.toLowerCase().includes("discount")))&&i.status==="Rejected"});return e&&((t=e.options)!=null&&t.reason)?`<div class="coupon-error">${e.options.reason}</div>`:""}isSuccessfullyAppliedCoupon(){return!this.orderEstimate||!this.orderEstimate.cart?!1:!!this.orderEstimate.cart.find(t=>{var o,a;return(t.itemType==="Coupon"||((o=t.description)==null?void 0:o.toLowerCase().includes("coupon"))&&!((a=t.itemType)!=null&&a.includes("Discount")))&&t.status!=="Rejected"})}getAppliedCouponName(){if(!this.orderEstimate||!this.orderEstimate.cart)return"";const e=this.orderEstimate.cart.find(t=>{var o,a;return(t.itemType==="Coupon"||((o=t.description)==null?void 0:o.toLowerCase().includes("coupon"))&&!((a=t.itemType)!=null&&a.includes("Discount")))&&t.status!=="Rejected"});return e?e.description:""}isDiscountSuccessfullyApplied(e){return!this.orderEstimate||!this.orderEstimate.cart?!1:this.orderEstimate.cart.some(t=>t.itemType==="Discount"&&(t.itemId===e||t.discountId===e)&&t.status!=="Rejected")}renderAddon(e){const t=this.selectedAddons.has(e.id),i=this.getCurrencySymbol(e.currencyCode),o=e.period,a=e.unitOfMeasurement?` per ${e.unitOfMeasurement}`:"",s=this.addonQuantities.get(e.id)||1;return`
              ...
              ${t?`
                <div class="addon-quantity-control">
                  ...
                  <div class="quantity-input-group" style="display: inline-flex; align-items: center;">
                    <button class="btn btn-sm qty-btn qty-decrease" data-addon-id="${e.id}" data-action="decrease" ${s<=1?"disabled":""}>-</button>
                    <input
                      type="number"
                      id="addon-qty-${e.id}"
                    ...
                    >
                    <button class="btn btn-sm qty-btn qty-increase" data-addon-id="${e.id}" data-action="increase" ${s>=999?"disabled":""}>+</button>
                  </div>
                </div>
              `:""}
            </div>
    ...
    `}renderOrderSummary(){if(!this.selectedPlan)return`
      ...
      `;const e=this.orderEstimate,t=this.getCurrencySymbol(e.currency||this.selectedPlan.currencyCode);let i="";const o=[],a=[],s=new Map;let n=null;if(e.cart&&e.cart.length>0&&e.cart.forEach(r=>{var m,h;if(!((r.itemType==="Discount"||r.itemType==="Coupon"||(m=r.description)!=null&&m.toLowerCase().includes("coupon")||(h=r.description)!=null&&h.toLowerCase().includes("discount"))&&r.status==="Rejected"))if(r.itemType==="Rate Plan"&&r.status==="Reserved"&&r.nextBillingDate&&(n=this.formatDisplayDate(r.nextBillingDate)),r.itemType==="Discount"&&r.itemId&&r.status!=="Reserved"){s.has(r.itemId)||s.set(r.itemId,{description:r.description,items:[],totalAmount:0});const u=s.get(r.itemId);u.items.push(r),u.totalAmount+=r.amount}else r.status==="Reserved"?a.push(r):o.push(r)}),o.forEach(r=>{var v,b;const p=r.itemType==="Discount"||r.itemType==="Coupon"||((v=r.description)==null?void 0:v.toLowerCase().includes("coupon"))||((b=r.description)==null?void 0:b.toLowerCase().includes("discount"));if(r.itemType==="Discount")return;const m=r.fromDate&&!p?this.formatDisplayDate(r.fromDate):"",h=r.toDate&&!p?this.formatDisplayDate(r.toDate):"",u=m&&h?`${m} - ${h}`:"";i+=`
        <div class="summary-item">
          <div class="item-details">
      ...
      `}),s.forEach((r,p)=>{const m=r.items.length>1;i+=`
              ...
              ${m?`
                <span class="discount-info-icon" data-discount-id="${p}">
                  ...
                  <div class="discount-tooltip">
                    ...
                    ${r.items.map(h=>{var v;return`<div class="tooltip-item">- ${((v=h.options)==null?void 0:v.itemType)||"Item"}: ${t}${h.amount.toFixed(2)}</div>`}).join("")}
                  </div>
                </span>
              `:""}
            </span>
        ...
        <div class="reserved-items-section">
          ${n?`
            <div class="reserved-billing-date">
              Next Billing Date - <span class="billing-date-value">${n}</span>
            </div>
          `:""}
          
          ${p.map(h=>{var g,$;const u=h.itemType==="Discount"||h.itemType==="Coupon"||((g=h.description)==null?void 0:g.toLowerCase().includes("coupon"))||(($=h.description)==null?void 0:$.toLowerCase().includes("discount")),v=h.fromDate&&!u?this.formatDisplayDate(h.fromDate):"",b=h.toDate&&!u?this.formatDisplayDate(h.toDate):"",x=v&&b?`${v} - ${b}`:"";return`
          ...
          ${Array.from(r.entries()).map(([h,u])=>{const v=u.items.length>1;return`
                  ...
                  <span class="item-name">
                    ...
                    ${v?`
                      <span class="discount-info-icon" data-discount-id="${h}">
                        ...
                        <div class="discount-tooltip">
                          <div class="tooltip-title">Applied on:</div>
                          ${u.items.map(b=>{var g;return`<div class="tooltip-item">- ${((g=b.options)==null?void 0:g.itemType)||"Item"}: ${t}${b.amount.toFixed(2)}</div>`}).join("")}
                        </div>
                      </span>
                    `:""}
                  </span>
      ...
      <style>
        ...
        *::-webkit-scrollbar-thumb:hover {
        ...
        .confirmation-success h2 {
          font-size: var(--billhive-font-size-heading, 24px);
          font-weight: 700;
          color: #10b981;
          margin: 0 0 12px 0;
        }

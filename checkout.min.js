(function(){"use strict";const f={baseUrl:"http://localhost:4001",apiKey:"7e4272f5dc4a2b44442910b1196bf402b09617f9d7a4c1db936583a9008a9fd7",productId:"cf190aae-cf47-44b0-9e11-6aa6f26bc403",endpoints:{pricingTable:n=>`/products/${n}/pricing-table`,products:"/products",subscriptions:"/subscriptions"},headers:{"Content-Type":"application/json",Accept:"application/json"},getAuthHeaders(){return{...this.headers,"api-key":this.apiKey}},getPricingTableUrl(n=null){const e=n||this.productId;return`${this.baseUrl}${this.endpoints.pricingTable(e)}`}};typeof module<"u"&&module.exports&&(module.exports=f),typeof window<"u"&&(window.ApiConfig=f);const m={layout:"standalone",theme:{colors:{accent:"#5b5bd6",header:"#f2ededff",highlightPanel:"#f7f7fe",card:"#ffffff",inputComponent:"#f9fafb",text:"#111827",subText:"#6b7280",borders:"#e2e8f0",error:"#dc2626",success:"#10b981",warning:"#f59e0b",loading:"#f9fafb",disabled:"#f3f4f6"},typography:{fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",fontSizeHeading:"1.275rem",fontSizeSubHeading:"1.25rem",fontSizeBodyText:"0.9375rem",fontSizeSubText:"0.875rem",fontSizeFootNotes:"0.8125rem",headerFontWeight:"700",elementBorderRadius:"4px",modalBorderRadius:"8px"},shadows:{card:"0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",modal:"0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)"}}},D={accentColor:"#5b5bd6",headerColor:"#f2ededff",highlightPanelColor:"#f7f7fe",cardsColor:"#ffffff",inputComponentsColor:"#f9fafb",fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",fontSizeHeading:"1.275rem",fontSizeSubHeading:"1.25rem",fontSizeBodyText:"0.9375rem",fontSizeSubText:"0.875rem",fontSizeFootNotes:"0.8125rem",headerFontWeight:"700",elementBorderRadius:"4px",modalBorderRadius:"8px",textColor:"#111827",subTextColor:"#6b7280",errorColor:"#dc2626",successColor:"#10b981",warningColor:"#f59e0b",loadingColor:"#f9fafb",disabledColor:"#f3f4f6",cardShadow:"0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",modalShadow:"0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)"};function w(n=m){let e="";return n.theme&&typeof n.theme=="object"?(n.theme.colors&&Object.entries(n.theme.colors).forEach(([t,i])=>{let o;switch(t){case"accent":o="--billhive-accent-color";break;case"header":o="--billhive-header-color";break;case"highlightPanel":o="--billhive-highlight-panel-color";break;case"card":o="--billhive-cards-color";break;case"inputComponent":o="--billhive-input-components-color";break;case"text":o="--billhive-text-color";break;case"subText":o="--billhive-sub-text-color";break;case"borders":o="--billhive-border-color";break;case"accentHover":o="--billhive-accent-hover";break;case"accentLight":o="--billhive-accent-light";break;default:o=`--billhive-${t.replace(/([A-Z])/g,"-$1").toLowerCase()}-color`}e+=`${o}: ${i};
    `}),n.theme.typography&&Object.entries(n.theme.typography).forEach(([t,i])=>{const o=`--billhive-${t.replace(/([A-Z])/g,"-$1").toLowerCase()}`;e+=`${o}: ${i};
    `}),n.theme.shadows&&Object.entries(n.theme.shadows).forEach(([t,i])=>{let o;switch(t){case"card":o="--billhive-card-shadow";break;case"modal":o="--billhive-modal-shadow";break;case"button":o="--billhive-button-shadow";break;default:o=`--billhive-${t}-shadow`}e+=`${o}: ${i};
    `}),n.layout&&(e+=`--billhive-layout: ${n.layout};
    `)):Object.entries(n).forEach(([t,i])=>{if(typeof i=="string"||typeof i=="number"){const o=`--billhive-${t.replace(/([A-Z])/g,"-$1").toLowerCase()}`;e+=`${o}: ${i};
    `}}),`
    :host {
      ${e.trim()}
    }
  `}function C(n={}){if(n.theme&&typeof n.theme=="object")return{layout:n.layout||m.layout,theme:{colors:{...m.theme.colors,...n.theme.colors||{}},typography:{...m.theme.typography,...n.theme.typography||{}},shadows:{...m.theme.shadows,...n.theme.shadows||{}}}};{const e={...D,...n};return E(e)}}function E(n){return{layout:n.layout||"standalone",theme:{colors:{accent:n.accentColor||m.theme.colors.accent,header:n.headerColor||m.theme.colors.header,highlightPanel:n.highlightPanelColor||m.theme.colors.highlightPanel,card:n.cardsColor||m.theme.colors.card,inputComponent:n.inputComponentsColor||m.theme.colors.inputComponent,text:n.textColor||m.theme.colors.text,subText:n.subTextColor||m.theme.colors.subText,borders:n.borderColor||m.theme.colors.borders,error:n.errorColor||m.theme.colors.error,success:n.successColor||m.theme.colors.success,warning:n.warningColor||m.theme.colors.warning,loading:n.loadingColor||m.theme.colors.loading,disabled:n.disabledColor||m.theme.colors.disabled},typography:{fontFamily:n.fontFamily||m.theme.typography.fontFamily,fontSizeHeading:n.fontSizeHeading||m.theme.typography.fontSizeHeading,fontSizeSubHeading:n.fontSizeSubHeading||m.theme.typography.fontSizeSubHeading,fontSizeBodyText:n.fontSizeBodyText||m.theme.typography.fontSizeBodyText,fontSizeSubText:n.fontSizeSubText||m.theme.typography.fontSizeSubText,fontSizeFootNotes:n.fontSizeFootNotes||m.theme.typography.fontSizeFootNotes,headerFontWeight:n.headerFontWeight||m.theme.typography.headerFontWeight,elementBorderRadius:n.elementBorderRadius||m.theme.typography.elementBorderRadius,modalBorderRadius:n.modalBorderRadius||m.theme.typography.modalBorderRadius},shadows:{card:n.cardShadow||m.theme.shadows.card,modal:n.modalShadow||m.theme.shadows.modal}}}}function y(n){const e=n.replace("#",""),t=parseInt(e.substr(0,2),16),i=parseInt(e.substr(2,2),16),o=parseInt(e.substr(4,2),16),s=Math.floor(t*.8),l=Math.floor(i*.8),c=Math.floor(o*.8);return{theme:{colors:{accentHover:`#${s.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}${c.toString(16).padStart(2,"0")}`,accentLight:`rgba(${t}, ${i}, ${o}, 0.1)`},shadows:{button:`0 2px 4px rgba(${t}, ${i}, ${o}, 0.3)`}}}}function k(n){const e=[];return n.theme&&typeof n.theme=="object"?(n.theme.colors&&(["accent","text"].forEach(i=>{n.theme.colors[i]||e.push(`Missing required color property: theme.colors.${i}`)}),Object.entries(n.theme.colors).forEach(([i,o])=>{o&&typeof o=="string"&&!o.match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})|rgba?\(.*\)$/)&&e.push(`Invalid color format for theme.colors.${i}: ${o}`)})),n.theme.typography&&["fontFamily"].forEach(i=>{n.theme.typography[i]||e.push(`Missing required typography property: theme.typography.${i}`)}),n.layout&&!["standalone","in-app"].includes(n.layout)&&e.push(`Invalid layout value: ${n.layout}. Must be 'standalone' or 'in-app'`)):(["accentColor","fontFamily"].forEach(o=>{n[o]||e.push(`Missing required theme property: ${o}`)}),["accentColor","headerColor","highlightPanelColor","cardsColor"].forEach(o=>{n[o]&&!n[o].match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/)&&e.push(`Invalid hex color format for ${o}: ${n[o]}`)})),{isValid:e.length===0,errors:e}}class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.selectedPlan=null,this.planId=null,this.isLoadingPlan=!1,this.planLoadError=null,this.addons=[],this.selectedAddons=new Set,this.addonQuantities=new Map,this.isLoadingAddons=!1,this.addonsLoadError=null,this.isVisible=!1,this.couponCode="",this.appliedCoupon=null,this.availableDiscounts=[],this.selectedDiscount=null,this.isLoadingOffers=!1,this.offersLoadError=null,this.updateTimeout=null,this.orderEstimate=null,this.isLoadingEstimate=!1,this.estimateError=null,this.estimateRequestId=0,this.currentModalStep="plan-selection",this.existingAccount=null,this.isCheckingExistingAccount=!1,this.createdOrder=null,this.isCreatingOrder=!1,this.orderCreated=!1,this.orderInvoices=[],this.isLoadingInvoices=!1,this.personalDetails={firstName:"",lastName:"",email:"",phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},this.formErrors={},this.selectedPaymentMethod="",this.orderData=null,this.paymentDetails={card:{cardNumber:"",expiryDate:"",cvv:"",cardholderName:""},upi:{upiId:""},netbanking:{bankName:""},wallet:{walletType:"",walletNumber:""}},this.theme=m,this.cashfreeInstance=null,this.cashfreeComponents={cardNumber:null,cardHolder:null,cardExpiry:null,cardCvv:null,upiCollect:null,wallets:new Map}}get themeData(){return this.theme}set themeData(e){e&&typeof e=="object"&&this.applyThemeData(e)}applyThemeData(e){var t,i;try{const o=k(e);if(o.isValid){this.theme={...m},this.theme=C(e);const s=((i=(t=e.theme)==null?void 0:t.colors)==null?void 0:i.accent)||e.accentColor;if(s){const l=y(s);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...l.theme.colors},shadows:{...this.theme.theme.shadows,...l.theme.shadows}}}}console.log("Checkout programmatic theme applied:",this.theme),this.render()}else console.warn("Invalid themeData configuration:",o.errors)}catch(o){console.warn("Error applying themeData:",o)}}static get observedAttributes(){return["data-plan","data-plan-id","visible","data-theme","theme-data"]}connectedCallback(){this.loadData(),this.loadCashfreeSDK(),this.render(),this.setupEventListeners()}async loadCashfreeSDK(){try{if(window.Cashfree){console.log("Cashfree SDK already loaded globally"),this.cashfreeInstance=window.Cashfree;return}const e=document.createElement("script");e.src="https://sdk.cashfree.com/js/v3/cashfree.js",e.async=!0,await new Promise((t,i)=>{e.onload=()=>{console.log("Cashfree SDK script loaded"),window.Cashfree?(this.cashfreeInstance=new window.Cashfree({mode:"sandbox"}),console.log("✅ Cashfree SDK initialized successfully"),t()):i(new Error("Cashfree object not found after script load"))},e.onerror=i,document.head.appendChild(e)})}catch(e){console.error("❌ Failed to load Cashfree SDK:",e)}}attributeChangedCallback(e,t,i){t!==i&&(e==="data-plan"?this.loadPlan():e==="data-plan-id"?this.planId=i:e==="visible"?this.isVisible=i==="true":e==="data-theme"&&this.loadTheme(),this.render())}loadData(){this.planId=this.getAttribute("data-plan-id"),this.planId||(this.loadPlan(),this.addons=[]),this.isVisible=this.getAttribute("visible")==="true",this.loadTheme()}loadTheme(){var i,o,s,l;this.theme={...m};const e=((o=(i=this.theme.theme)==null?void 0:i.colors)==null?void 0:o.accent)||this.theme.accentColor;if(e){const c=y(e);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...c.theme.colors},shadows:{...this.theme.theme.shadows,...c.theme.shadows}}}}console.log("Checkout theme loaded:",this.theme);const t=this.getAttribute("data-theme");if(console.log("themeAtr :",t),t)try{const c=JSON.parse(t),r=k(c);if(r.isValid){this.theme=C(c);const a=((l=(s=c.theme)==null?void 0:s.colors)==null?void 0:l.accent)||c.accentColor;if(a){const d=y(a);this.theme={...this.theme,theme:{...this.theme.theme,colors:{...this.theme.theme.colors,...d.theme.colors},shadows:{...this.theme.theme.shadows,...d.theme.shadows}}}}console.log("Checkout custom theme applied:",this.theme)}else console.warn("Invalid theme configuration:",r.errors)}catch(c){console.warn("Invalid JSON in data-theme attribute:",c)}}loadPlan(){const e=this.getAttribute("data-plan");if(e)try{this.selectedPlan=JSON.parse(e)}catch{this.selectedPlan=null}else this.selectedPlan={id:"professional",name:"Professional",description:"Perfect for growing businesses",price:49,period:"month",features:["Unlimited invoices","Up to 10 team members","Advanced analytics","Priority support","API access"]}}async loadPlanFromApi(){var e,t;if(this.planId){this.isLoadingPlan=!0,this.planLoadError=null;try{const i=((e=window.ApiConfig)==null?void 0:e.baseUrl)||f.baseUrl,o=((t=window.ApiConfig)==null?void 0:t.apiKey)||f.apiKey,s=`${i}/rate-plan-prices/${this.planId}`,l=await fetch(s,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":o}});if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);const c=await l.json();this.selectedPlan=this.transformPlanApiData(c),this.isLoadingPlan=!1,this.planLoadError=null,this.render(),this.loadAddonsFromApi().catch(r=>{console.error("Failed to load addons:",r)}),this.loadApplicableOffers().catch(r=>{console.error("Failed to load applicable offers:",r)}),this.updateOrderSummary()}catch(i){this.planLoadError=i.message,this.isLoadingPlan=!1,this.isLoadingAddons=!1,this.loadPlan(),this.addons=[],this.render()}}}transformPlanApiData(e){var i,o,s;return{id:e.ratePlanId,ratePlanPriceId:e.ratePlanPriceId,name:e.name||e.externalName,description:e.description,price:e.price,currencyCode:e.currencyCode,period:((i=e.billingPeriod)==null?void 0:i.periodName)||((o=e.billingPeriod)==null?void 0:o.period),periodName:(s=e.billingPeriod)==null?void 0:s.periodName,billingPeriod:e.billingPeriod,features:e.addons||e.features||[],recommended:e.mostPopular||!1,planLevel:e.planLevel,isTrial:e.isTrial,trialPeriod:e.trialPeriod,ratePlanKey:e.ratePlanKey,productName:e.productName,productId:e.productId,status:e.status,isVisibleInPortal:e.isVisibleInPortal,isVisibleInCheckout:e.isVisibleInCheckout,requireBillingAtSignup:e.requireBillingAtSignup,autoRenew:e.autoRenew,termLength:e.termLength,taxIncluded:e.taxIncluded,pricingModel:e.pricingModel,billingCycle:e.billingCycle}}async loadAddonsFromApi(){var e,t,i;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){this.addons=[];return}this.isLoadingAddons=!0,this.addonsLoadError=null;try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=encodeURIComponent('{"where":{"applicability":{"neq":"Mandatory"}}}'),c=`${o}/rate-plan-prices/${this.selectedPlan.ratePlanPriceId}/addons?filter=${l}`,r=await fetch(c,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s}});if(!r.ok)throw new Error(`Failed to fetch addons: HTTP ${r.status}`);const a=await r.json();this.addons=this.transformAddonsApiData(a),this.isLoadingAddons=!1,this.addonsLoadError=null,this.render()}catch(o){console.error("Error loading addons:",o),this.addonsLoadError=o.message,this.isLoadingAddons=!1,this.addons=[],this.render()}}transformAddonsApiData(e){return Array.isArray(e)?e.map(t=>{var i,o;return{id:t.addonPriceId,addonId:t.addonId,addonPriceId:t.addonPriceId,name:t.externalName||t.name,description:t.description,price:t.price,quantity:t.quantity||1,unitOfMeasurement:t.unitOfMeasurement,period:(o=(i=t.billingPeriod)==null?void 0:i.periodName)==null?void 0:o.toLowerCase(),billingPeriod:t.billingPeriod,currencyCode:t.currencyCode,pricingModel:t.pricingModel,applicability:t.applicability,isPriceIncluded:t.isPriceIncluded,isVisibleInPortal:t.isVisibleInPortal,status:t.status,addonPriceKey:t.addonPriceKey}}):[]}async loadApplicableOffers(){var e,t,i;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){console.warn("No ratePlanPriceId available to load offers"),this.availableDiscounts=[];return}this.isLoadingOffers=!0,this.offersLoadError=null,this.render();try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=`${o}/applicable-offers`,c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s},body:JSON.stringify({ratePlanPriceId:this.selectedPlan.ratePlanPriceId})});if(!c.ok)throw new Error(`Failed to fetch applicable offers: HTTP ${c.status}`);const r=await c.json();this.availableDiscounts=r.map(a=>{var d;return{id:a.id,name:a.externalName||a.name,description:a.description,type:a.discountType==="Percentage"?"percentage":"fixed",value:a.amount,code:((d=a.code)==null?void 0:d.trim())||`OFFER${a.id.slice(-8).toUpperCase()}`,apiData:{tenantId:a.tenantId,applyOn:a.applyOn,discountDurationType:a.discountDurationType,expiryDate:a.expiryDate,maxRedemptionCount:a.maxRedemptionCount,maxRedemptionCountPerCustomer:a.maxRedemptionCountPerCustomer,minimumPurchaseAmount:a.minimumPurchaseAmount,status:a.status}}}).filter(a=>a.apiData.status==="Active"),this.isLoadingOffers=!1,this.offersLoadError=null}catch(o){console.error("Error loading applicable offers:",o),this.isLoadingOffers=!1,this.offersLoadError=o.message,this.availableDiscounts=[]}this.render()}async loadOrderEstimate(){var t,i;this.estimateRequestId+=1;const e=this.estimateRequestId;this.isLoadingEstimate=!0,this.estimateError=null,this.orderEstimate=null,this.render();try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=`${o}/orders/estimate`,c=this.buildEstimateRequestBody(),r=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s},body:JSON.stringify(c)});if(e!==this.estimateRequestId)return;if(!r.ok)throw new Error(`Failed to fetch order estimate: HTTP ${r.status}`);const a=await r.json();console.log("Order estimate received:",a),e===this.estimateRequestId&&(this.orderEstimate=a,this.isLoadingEstimate=!1,this.estimateError=null)}catch(o){e===this.estimateRequestId&&(console.error("Error loading order estimate:",o),this.isLoadingEstimate=!1,this.estimateError=o.message,this.orderEstimate=null)}e===this.estimateRequestId&&this.render()}buildEstimateRequestBody(){var o;const e=[],t=new Date().toISOString().split("T")[0];return this.selectedPlan&&(e.push({itemType:"Rate Plan",itemId:this.selectedPlan.ratePlanPriceId,quantity:1,options:{startDate:t,billingCycle:1,autoRenew:!1,autoCollect:!1,invoiceGenerationPreference:"Immediately"}}),this.selectedAddons.forEach(s=>{const l=this.addons.find(c=>c.id===s);l&&e.push({itemType:"Addon",itemId:l.addonPriceId,quantity:this.addonQuantities.get(s)||1,options:{ratePlanPriceId:this.selectedPlan.ratePlanPriceId}})})),this.selectedDiscount&&e.push({itemType:"Discount",itemId:this.selectedDiscount.id,quantity:1}),console.log("Applied coupon is:",this.appliedCoupon),this.appliedCoupon&&e.push({itemType:"Coupon",itemId:this.appliedCoupon.code,quantity:1,options:{startDate:t}}),{srcSysCode:"Website",eventType:"NEW SUBSCRIPTION",currency:(o=this.selectedPlan)==null?void 0:o.currencyCode,scheduleDate:t,cart:e,personalInfo:{}}}buildPlaceOrderRequestBody(e){const t=this.buildEstimateRequestBody();return t.personalInfo={accountId:e},t}async placeOrder(e){var t,i;if(this.orderCreated)return console.log("Order already created, skipping duplicate creation"),this.createdOrder;if(this.isCreatingOrder){console.log("Order creation in progress, skipping duplicate request");return}try{this.isCreatingOrder=!0;const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=`${o}/orders/place`,c=this.buildPlaceOrderRequestBody(e);console.log("Placing order with request body:",c);const r=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s},body:JSON.stringify(c)});if(!r.ok)throw new Error(`Failed to place order: HTTP ${r.status}`);const a=await r.json();return console.log("Order placed successfully:",a),this.createdOrder=a,this.orderCreated=!0,this.isCreatingOrder=!1,a}catch(o){throw console.error("Error placing order:",o),this.isCreatingOrder=!1,o}}async getOrderInvoices(e){var t,i;if(!e){console.error("Order ID is required to fetch invoices");return}if(this.isLoadingInvoices){console.log("Invoices loading in progress, skipping duplicate request");return}try{this.isLoadingInvoices=!0;const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=encodeURIComponent(JSON.stringify({where:{status:"Posted",orderId:e}})),c=`${o}/invoices?filter=${l}`;console.log("Fetching invoices for order:",e);const r=await fetch(c,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s}});if(!r.ok)throw new Error(`Failed to fetch invoices: HTTP ${r.status}`);const a=await r.json();return console.log("Invoices fetched successfully:",a),this.orderInvoices=a,this.isLoadingInvoices=!1,a}catch(o){throw console.error("Error fetching invoices:",o),this.isLoadingInvoices=!1,this.orderInvoices=[],o}}async updateAccount(e){var t,i,o,s;try{const l=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,c=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,r=`${l}/accounts/${e}`,a={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1},d=await fetch(r,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":c},body:JSON.stringify(a)});if(!d.ok)throw new Error(`Failed to update account: HTTP ${d.status}`);let h;return d.status===204?(console.log("Customer account updated successfully (204 No Content)"),h={...this.existingAccount,accountId:e,name:a.name,country:a.country,address:a.address,state:a.state,city:a.city,zipCode:a.zipCode,phone:a.phone,email:a.email,accountType:a.accountType,communicationProfile:this.existingAccount.communicationProfile}):(h=await d.json(),console.log("Customer account updated:",h)),a.accountType==="Organisation"&&((s=(o=this.existingAccount)==null?void 0:o.communicationProfile)!=null&&s.contactId)&&await this.updateContact(e,this.existingAccount.communicationProfile.contactId),h}catch(l){throw console.error("Error updating account:",l),l}}async updateContact(e,t){var i,o,s,l,c,r;try{const a=((i=window.ApiConfig)==null?void 0:i.baseUrl)||f.baseUrl,d=((o=window.ApiConfig)==null?void 0:o.apiKey)||f.apiKey,h=`${a}/accounts/${e}/contacts/${t}`,p={fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,email:this.personalDetails.email,address:this.personalDetails.address.addressLine,billNotification:(l=(s=this.existingAccount)==null?void 0:s.communicationProfile)==null?void 0:l.billNotification,accountNotification:(r=(c=this.existingAccount)==null?void 0:c.communicationProfile)==null?void 0:r.accountNotification,phone:this.personalDetails.phone};console.log("Updating contact:",t,p);const u=await fetch(h,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":d},body:JSON.stringify(p)});if(!u.ok)throw new Error(`Failed to update contact: HTTP ${u.status}`);if(u.status===204)return console.log("Contact updated successfully (204 No Content)"),{success:!0};const b=await u.json();return console.log("Contact updated:",b),b}catch(a){throw console.error("Error updating contact:",a),a}}async createCustomerAccount(){var e,t;try{if(this.existingAccount&&this.existingAccount.accountId){console.log("Updating existing Draft account:",this.existingAccount);const a=await this.updateAccount(this.existingAccount.accountId);return this.createdAccountId=a.id||a.accountId,a}const i=((e=window.ApiConfig)==null?void 0:e.baseUrl)||f.baseUrl,o=((t=window.ApiConfig)==null?void 0:t.apiKey)||f.apiKey,s=`${i}/accounts`,l={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1,communicationProfile:{fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),address:this.personalDetails.address.addressLine,country:this.personalDetails.address.country,phone:this.personalDetails.phone,email:this.personalDetails.email}},c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":o},body:JSON.stringify(l)});if(!c.ok)throw new Error(`Failed to create customer account: HTTP ${c.status}`);const r=await c.json();return console.log("Customer account created:",r),this.createdAccountId=r.accountId,r}catch(i){throw console.error("Error creating customer account:",i),i}}async checkExistingAccount(e){var t,i;try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||f.baseUrl,s=((i=window.ApiConfig)==null?void 0:i.apiKey)||f.apiKey,l=`${o}/accounts?filter=${encodeURIComponent(JSON.stringify({where:{email:e}}))}`,c=await fetch(l,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s}});if(!c.ok)throw new Error(`Failed to check existing account: HTTP ${c.status}`);const r=await c.json();return console.log("Existing account check result:",r),r.accounts&&r.accounts.length>0?r.accounts[0]:null}catch(o){return console.error("Error checking existing account:",o),null}}async handleEmailCheck(e){if(console.log("Checking email:",e),this.isCheckingExistingAccount){console.log("Already checking, skipping...");return}this.isCheckingExistingAccount=!0,this.existingAccount=null,this.hideExistingAccountMessage(),delete this.formErrors.email,this.updateFieldError("email");try{const t=await this.checkExistingAccount(e);console.log("Found existing account:",t),t&&t.accountId?t.status==="Active"?(console.log("Account is Active, showing error"),this.formErrors.email="Email ID is already associated with another account, please use another email ID",this.updateFieldError("email"),this.updateNextButtonState()):t.status==="Draft"&&(console.log("Account is Draft, prefilling details"),t&&(this.existingAccount=t,this.showExistingAccountMessage(t),await this.prefillAccountDetails(t))):(console.log("No existing account found"),this.hideExistingAccountMessage())}catch(t){console.error("Error during email check:",t)}finally{this.isCheckingExistingAccount=!1}}async prefillAccountDetails(e){console.log("Prefilling account details:",e),console.log("Current personal details before prefill:",this.personalDetails);const t=this.personalDetails.email;if(this.personalDetails={firstName:"",lastName:"",email:t,phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},e.accountType==="Organisation"){if(console.log("Organisation account detected"),this.personalDetails.company=e.name,console.log("Prefilled company:",this.personalDetails.company),e.communicationProfile&&e.communicationProfile.fullName){const i=e.communicationProfile.fullName.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName from communicationProfile:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName from communicationProfile:",this.personalDetails.lastName))}}else if(console.log("Individual account detected"),e.name){const i=e.name.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName:",this.personalDetails.lastName))}e.phone&&(this.personalDetails.phone=e.phone,console.log("Prefilled phone:",this.personalDetails.phone)),e.address&&(this.personalDetails.address.addressLine=e.address,console.log("Prefilled addressLine:",this.personalDetails.address.addressLine)),e.city&&(this.personalDetails.address.city=e.city,console.log("Prefilled city:",this.personalDetails.address.city)),e.state&&(this.personalDetails.address.state=e.state,console.log("Prefilled state:",this.personalDetails.address.state)),e.zipCode&&(this.personalDetails.address.zipCode=e.zipCode,console.log("Prefilled zipCode:",this.personalDetails.address.zipCode)),e.country&&(this.personalDetails.address.country=e.country,console.log("Prefilled country:",this.personalDetails.address.country)),console.log("Personal details after prefill:",this.personalDetails),this.render(),this.updateNextButtonState()}showExistingAccountMessage(e){const t=this.shadowRoot.querySelector('[data-field="email"]');if(t){let i=this.shadowRoot.querySelector(".existing-account-message");i||(i=document.createElement("div"),i.className="existing-account-message",t.parentNode.appendChild(i)),i.innerHTML=`
          ...
          <div class="order-summary-content">
            ...
            <div class="available-discounts-section">
              ...
              <div class="available-discounts-grid">
                ...
                `:this.availableDiscounts.map(e=>{var s;const t=((s=this.selectedDiscount)==null?void 0:s.id)===e.id,i=this.isDiscountSuccessfullyApplied(e.id),o=e.type==="percentage"?`${e.value}% off`:`$${e.value} off`;return`
    ...
    `}getCurrencySymbol(e){return{USD:"$",EUR:"€",GBP:"£",INR:"₹",JPY:"¥",CNY:"¥",AUD:"A$",CAD:"C$",CHF:"Fr",SEK:"kr",NZD:"NZ$"}[e]||e||"$"}formatDisplayDate(e){if(!e)return"";try{return new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}catch(t){return console.error("Error formatting date:",t),e}}isCouponRejected(){return!this.orderEstimate||!this.orderEstimate.cart?!1:this.orderEstimate.cart.some(e=>{var i,o;return(e.itemType==="Discount"||e.itemType==="Coupon"||((i=e.description)==null?void 0:i.toLowerCase().includes("coupon"))||((o=e.description)==null?void 0:o.toLowerCase().includes("discount")))&&e.status==="Rejected"})}getCouponStatusMessage(){var t;if(!this.orderEstimate||!this.orderEstimate.cart)return"";const e=this.orderEstimate.cart.find(i=>{var s,l;return(i.itemType==="Discount"||i.itemType==="Coupon"||((s=i.description)==null?void 0:s.toLowerCase().includes("coupon"))||((l=i.description)==null?void 0:l.toLowerCase().includes("discount")))&&i.status==="Rejected"});return e&&((t=e.options)!=null&&t.reason)?`<div class="coupon-error">${e.options.reason}</div>`:""}isSuccessfullyAppliedCoupon(){return!this.orderEstimate||!this.orderEstimate.cart?!1:!!this.orderEstimate.cart.find(t=>{var o,s;return(t.itemType==="Coupon"||((o=t.description)==null?void 0:o.toLowerCase().includes("coupon"))&&!((s=t.itemType)!=null&&s.includes("Discount")))&&t.status!=="Rejected"})}getAppliedCouponName(){if(!this.orderEstimate||!this.orderEstimate.cart)return"";const e=this.orderEstimate.cart.find(t=>{var o,s;return(t.itemType==="Coupon"||((o=t.description)==null?void 0:o.toLowerCase().includes("coupon"))&&!((s=t.itemType)!=null&&s.includes("Discount")))&&t.status!=="Rejected"});return e?e.description:""}isDiscountSuccessfullyApplied(e){return!this.orderEstimate||!this.orderEstimate.cart?!1:this.orderEstimate.cart.some(t=>t.itemType==="Discount"&&(t.itemId===e||t.discountId===e)&&t.status!=="Rejected")}renderAddon(e){const t=this.selectedAddons.has(e.id),i=this.getCurrencySymbol(e.currencyCode),o=e.period,s=e.unitOfMeasurement?` per ${e.unitOfMeasurement}`:"",l=this.addonQuantities.get(e.id)||1;return`
          ...
          <div class="addon-right">
            <div class="addon-price-section">
              <span class="addon-price">
                ${e.isPriceIncluded?"Included":`+${i}${e.price}/${o}${s}`}
              </span>
              ${t?`
                <div class="addon-quantity-control">
                  ...
                  <div class="quantity-input-group" style="display: inline-flex; align-items: center;">
                    <button class="qty-btn qty-decrease" data-addon-id="${e.id}" data-action="decrease" ${l<=1?"disabled":""}>-</button>
                    <input 
                      type="number" 
                      id="addon-qty-${e.id}"
                    ...
                    >
                    <button class="qty-btn qty-increase" data-addon-id="${e.id}" data-action="increase" ${l>=999?"disabled":""}>+</button>
                  </div>
                </div>
              `:""}
            </div>
    ...
    `}renderOrderSummary(){if(!this.selectedPlan)return"<p>No plan selected</p>";if(this.isLoadingEstimate)return`
      ...
      `;const e=this.orderEstimate,t=this.getCurrencySymbol(e.currency||this.selectedPlan.currencyCode);let i="";const o=[],s=[],l=new Map;let c=null;if(e.cart&&e.cart.length>0&&e.cart.forEach(a=>{var h,p;if(!((a.itemType==="Discount"||a.itemType==="Coupon"||(h=a.description)!=null&&h.toLowerCase().includes("coupon")||(p=a.description)!=null&&p.toLowerCase().includes("discount"))&&a.status==="Rejected"))if(a.itemType==="Rate Plan"&&a.status==="Reserved"&&a.nextBillingDate&&(c=this.formatDisplayDate(a.nextBillingDate)),a.itemType==="Discount"&&a.itemId&&a.status!=="Reserved"){l.has(a.itemId)||l.set(a.itemId,{description:a.description,items:[],totalAmount:0});const u=l.get(a.itemId);u.items.push(a),u.totalAmount+=a.amount}else a.status==="Reserved"?s.push(a):o.push(a)}),o.forEach(a=>{var b,v;const d=a.itemType==="Discount"||a.itemType==="Coupon"||((b=a.description)==null?void 0:b.toLowerCase().includes("coupon"))||((v=a.description)==null?void 0:v.toLowerCase().includes("discount"));if(a.itemType==="Discount")return;const h=a.fromDate&&!d?this.formatDisplayDate(a.fromDate):"",p=a.toDate&&!d?this.formatDisplayDate(a.toDate):"",u=h&&p?`${h} - ${p}`:"";i+=`
      ...
      `}),l.forEach((a,d)=>{const h=a.items.length>1;i+=`
              ...
              ${h?`
                <span class="discount-info-icon" data-discount-id="${d}">
                  ...
                  <div class="discount-tooltip">
                    ...
                    ${a.items.map(p=>{var b;return`<div class="tooltip-item">- ${((b=p.options)==null?void 0:b.itemType)||"Item"}: ${t}${p.amount.toFixed(2)}</div>`}).join("")}
                  </div>
                </span>
              `:""}
            </span>
      ...
      `}),s.length>0){const a=new Map,d=[];s.forEach(p=>{if(p.itemType==="Discount"&&p.itemId){a.has(p.itemId)||a.set(p.itemId,{description:p.description,items:[],totalAmount:0});const u=a.get(p.itemId);u.items.push(p),u.totalAmount+=p.amount}else d.push(p)});const h=s.reduce((p,u)=>p+u.amount,0);i+=`
        <div class="reserved-items-section">
          ${c?`
            <div class="reserved-billing-date">
              Next Billing Date - <span class="billing-date-value">${c}</span>
            </div>
          `:""}
          
          ${d.map(p=>{var g,$;const u=p.itemType==="Discount"||p.itemType==="Coupon"||((g=p.description)==null?void 0:g.toLowerCase().includes("coupon"))||(($=p.description)==null?void 0:$.toLowerCase().includes("discount")),b=p.fromDate&&!u?this.formatDisplayDate(p.fromDate):"",v=p.toDate&&!u?this.formatDisplayDate(p.toDate):"",x=b&&v?`${b} - ${v}`:"";return`
              <div class="summary-item reserved-item">
                <div class="item-details">
                  <span class="item-name">${p.description}</span>
                  ${x?`<span class="item-dates">${x}</span>`:""}
                </div>
                <span class="item-price ${u?"discount-price":""}">
                  ${u?"-":""}${t}${p.amount.toFixed(2)}
                </span>
              </div>
            `}).join("")}
          
          ${Array.from(a.entries()).map(([p,u])=>{const b=u.items.length>1;return`
          ...
          <div class="reserved-subtotal">
            ...
            <span class="subtotal-price">${t}${h.toFixed(2)}</span>
          </div>
        </div>
      `}i+=`
    ...
    `;const r=e.discounts?e.discounts.reduce((a,d)=>a+d.amount,0):0;return r>0&&(i+=`
        <div class="savings-notice">
          You save ${t}${r.toFixed(2)}!
        </div>
      ...
      <style>
        ...
        .page-sidebar {
          ...
          border-left: 1px solid var(--billhive-border-color, #e7ecf3);
          display: flex;
          flex-direction: column;
          padding-left: 1rem;
        }

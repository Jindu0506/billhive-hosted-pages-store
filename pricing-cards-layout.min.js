this.PricingCardsLayout=function(){"use strict";function B(n){let e="";return n.theme&&typeof n.theme=="object"&&(n.theme.colors&&Object.entries(n.theme.colors).forEach(([i,a])=>{let t;switch(i){case"accent":t="--billhive-accent-color";break;case"header":t="--billhive-header-color";break;case"highlightPanel":t="--billhive-highlight-panel-color";break;case"card":t="--billhive-cards-color";break;case"inputComponent":t="--billhive-input-components-color";break;case"text":t="--billhive-text-color";break;case"subText":t="--billhive-sub-text-color";break;case"borders":t="--billhive-border-color";break;case"accentHover":t="--billhive-accent-hover";break;case"accentLight":t="--billhive-accent-light";break;default:t=`--billhive-${i.replace(/([A-Z])/g,"-$1").toLowerCase()}-color`}e+=`${t}: ${a};
  ...
  `}const d={baseUrl:"http://localhost:4001",endpoints:{pricingTable:n=>`/products/${n}/pricing-table`,products:"/products",subscriptions:"/subscriptions"},headers:{"Content-Type":"application/json",Accept:"application/json"},getAuthHeaders(){return{...this.headers,"api-key":this.apiKey}},getPricingTableUrl(n=null){const e=n||this.productId;return`${this.baseUrl}${this.endpoints.pricingTable(e)}`}};typeof module<"u"&&module.exports&&(module.exports=d),typeof window<"u"&&(window.ApiConfig=d);class c extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.plans=[],this.allPlans=[],this.selectedPeriod=null,this.availablePeriods=[],this.isLoading=!1,this.apiError=null,this.theme=null,this.cardConfig=null,this.isCheckout=!1,this.productId="",this.apiKey=""}static get observedAttributes(){return["data-theme","product-id","api-key"]}connectedCallback(){this.productId=this.getAttribute("product-id"),this.apiKey=this.getAttribute("api-key");const e=this.getAttribute("data-theme");if(e)try{const i=JSON.parse(e);this.theme=i,this.cardConfig=i.card}catch(i){console.error("Error parsing data-theme:",i)}console.log("=== Pricing Cards Input Attributes ==="),console.log("product-id:",this.productId),console.log("api-key:",this.apiKey),console.log("theme:",this.theme),console.log("cardConfig:",this.cardConfig),console.log("====================================="),this.loadPlansFromApi()}async loadPlansFromApi(){this.isLoading=!0,this.apiError=null,this.renderLoadingState();try{const e=`${d.baseUrl}/products/${this.productId}/pricing-table`;console.log("Fetching pricing data from:",e);const i=await fetch(e,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!i.ok)throw new Error(`HTTP error! status: ${i.status}`);const a=await i.json();console.log("API Response:",a),this.allPlans=this.transformApiData(a),this.setupPeriodFiltering(),this.isLoading=!1,this.isCheckout?this.loadPlanSelectorComponent().then(()=>{this.render()}).catch(t=>{console.error("Error loading plan-selector, falling back to buttons:",t),this.isCheckout=!1,this.render()}):this.render()}catch(e){console.error("Error fetching pricing data:",e),this.apiError=e.message,this.isLoading=!1,this.allPlans=this.getDefaultPlans(),this.setupPeriodFiltering(),this.render()}}loadPlanSelectorComponent(){if(customElements.get("plan-selector"))return Promise.resolve();const e=document.querySelector('script[data-component="plan-selector"]');if(e)return new Promise(r=>{e.dataset.loaded==="true"?r():e.addEventListener("load",r)});const i=["./dist/web-components/plan-selector.min.js","../dist/web-components/plan-selector.min.js","/dist/web-components/plan-selector.min.js","dist/web-components/plan-selector.min.js"],a=document.currentScript||document.querySelector('script[src*="pricing-cards"]');let t=i[0];return a&&a.src&&(t=`${a.src.substring(0,a.src.lastIndexOf("/"))}/plan-selector.min.js`),new Promise((r,l)=>{const o=document.createElement("script");o.src=t,o.dataset.component="plan-selector",o.dataset.loaded="false",o.onload=()=>{o.dataset.loaded="true",console.log("Plan-selector component loaded successfully"),r()},o.onerror=()=>{console.error(`Failed to load plan-selector component from: ${t}`),l(new Error("Failed to load plan-selector component"))},document.head.appendChild(o)})}attributeChangedCallback(e,i,a){i!==a&&(console.log("attribute changed :",e,a),e==="data-theme"&&(this.theme=a,this.cardConfig=this.theme.card),this.isCheckout?this.loadPlanSelectorComponent().then(()=>{this.render()}).catch(t=>{console.error("Error loading plan-selector, falling back to buttons:",t),this.isCheckout=!1,this.render()}):this.render())}transformApiData(e){try{return e&&Array.isArray(e)?e.map(i=>{var a,t,r,l;return{id:i.ratePlanPriceId,name:i.name||i.externalName,description:i.description||i.customerDescription||"",price:i.price,currencyCode:i.currencyCode,period:((a=i.billingPeriod)==null?void 0:a.periodName)||((t=i.billingPeriod)==null?void 0:t.period),periodId:(r=i.billingPeriod)==null?void 0:r.id,periodName:(l=i.billingPeriod)==null?void 0:l.periodName,planLevel:i.planLevel||0,userNumber:1,features:i.addons||[],recommended:i.mostPopular||!1,tags:i.mostPopular||!1}}).sort((i,a)=>i.planLevel-a.planLevel):(console.warn("Invalid API data structure, using default plans"),this.getDefaultPlans())}catch(i){return console.error("Error transforming API data:",i),this.getDefaultPlans()}}setupPeriodFiltering(){const e=new Map;this.allPlans.forEach(i=>{i.periodId&&i.periodName&&e.set(i.periodId,i.periodName)}),this.availablePeriods=Array.from(e.entries()).map(([i,a])=>({id:i,name:a})),this.selectedPeriod=this.availablePeriods.length>0?this.availablePeriods[0].id:null,this.filterPlansByPeriod()}filterPlansByPeriod(){this.selectedPeriod?this.plans=this.allPlans.filter(e=>e.periodId===this.selectedPeriod):this.plans=this.allPlans}handlePeriodChange(e){this.selectedPeriod=e,this.filterPlansByPeriod(),this.render()}getCurrencySymbol(e){return{USD:"$",EUR:"€",GBP:"£",INR:"₹",JPY:"¥",CAD:"C$",AUD:"A$",CHF:"CHF",CNY:"¥",SEK:"kr",NZD:"NZ$",MXN:"$",SGD:"S$",HKD:"HK$",NOK:"kr",TRY:"₺",RUB:"₽",BRL:"R$",ZAR:"R",KRW:"₩"}[e==null?void 0:e.toUpperCase()]||e||"$"}renderLoadingState(){this.shadowRoot.innerHTML=`
    ...
    `}handlePlanSelect(e){const i=new CustomEvent("plan-selected",{detail:{selectedPlan:e},bubbles:!0});this.dispatchEvent(i)}render(){var i,a;console.log("render function");const e=((a=(i=this.theme.card)==null?void 0:i.layout)==null?void 0:a.layoutMode)==="grid";console.log("config check :",this.cardConfig,e),this.shadowRoot.innerHTML=`
      ${this.getStyles()}
      <div class="pricing-display">
    ...
    `}renderPlan(e){var i,a,t,r;if(((a=(i=this.theme.card)==null?void 0:i.layout)==null?void 0:a.layoutMode)==="card")return`
      ...
      `;if(((r=(t=this.theme.card)==null?void 0:t.layout)==null?void 0:r.layoutMode)==="horizontal-card"){const l=`<svg class="feature-check-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      `}else return""}getStyles(){var r,l,o,s,h,b,f,m,p,v,g,u,y,x,w,z,$,k,P,C,S,L,A,E,j,I,T,M,N,R;console.log("getStyles :",this.theme,this.cardConfig);const e=((l=(r=this.theme.card)==null?void 0:r.style)==null?void 0:l.shadow)||"0 2px 8px rgba(0, 0, 0, 0.08)",i=((s=(o=this.theme.card)==null?void 0:o.style)==null?void 0:s.borderColor)||"#dbdfea",a=((b=(h=this.theme.card)==null?void 0:h.style)==null?void 0:b.spacing)||"20px",t=((m=(f=this.theme.card)==null?void 0:f.layout)==null?void 0:m.columns)||4;return`
      <style>
        ${B(this.theme)}
        ...
        * {
        ...
        .pricing-container {
          display: ${((v=(p=this.theme.card)==null?void 0:p.layout)==null?void 0:v.layoutMode)==="grid"?"block":((u=(g=this.theme.card)==null?void 0:g.layout)==null?void 0:u.layoutMode)==="horizontal-card"||((x=(y=this.theme.card)==null?void 0:y.layout)==null?void 0:x.layoutMode)==="list"?"flex":(((z=(w=this.theme.card)==null?void 0:w.layout)==null?void 0:z.layoutMode)==="card","grid")};
          ${((k=($=this.theme.card)==null?void 0:$.layout)==null?void 0:k.layoutMode)==="horizontal-card"||((C=(P=this.theme.card)==null?void 0:P.layout)==null?void 0:C.layoutMode)==="list"?"flex-direction: column;":((L=(S=this.theme.card)==null?void 0:S.layout)==null?void 0:L.layoutMode)==="card"?`grid-template-columns: repeat(${t}, 1fr);`:((E=(A=this.theme.card)==null?void 0:A.layout)==null?void 0:E.layoutMode)==="grid"?"":`grid-template-columns: repeat(${t}, 1fr);`}
          gap: ${((I=(j=this.theme.card)==null?void 0:j.layout)==null?void 0:I.layoutMode)==="grid"?"0":a};
          margin-bottom: 2rem;
          max-width: ${((M=(T=this.theme.card)==null?void 0:T.layout)==null?void 0:M.layoutMode)==="grid"?"100%":((R=(N=this.theme.card)==null?void 0:N.layout)==null?void 0:R.layoutMode)==="horizontal-card"?"1200px":"1000px"};
          margin-left: auto;
          margin-right: auto;
        }

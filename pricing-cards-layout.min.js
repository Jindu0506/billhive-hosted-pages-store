this.PricingCardsLayout=function(){"use strict";function z(o,e=null){let r="";switch(console.log("generateThemeCSS :",o),e){case"Pricing-Table":return o.branding&&(o.branding.primaryColor&&(r+=`--billhive-primary-color: ${o.branding.primaryColor};
  ...
  `}const c={baseUrl:"http://localhost:4001",endpoints:{pricingTable:o=>`/products/${o}/pricing-table`,products:"/products",subscriptions:"/subscriptions"},headers:{"Content-Type":"application/json",Accept:"application/json"},getAuthHeaders(){return{...this.headers,"api-key":this.apiKey}},getPricingTableUrl(o=null){const e=o||this.productId;return`${this.baseUrl}${this.endpoints.pricingTable(e)}`}};typeof module<"u"&&module.exports&&(module.exports=c),typeof window<"u"&&(window.ApiConfig=c);class d extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.plans=[],this.allPlans=[],this.selectedPeriod=null,this.availablePeriods=[],this.isLoading=!1,this.apiError=null,this.theme=null,this.isCheckout=!1,this.productId="",this.apiKey="",this.buttonText="Select Plan",this.ratePlanConfig=null,this.currencyConfig=null,this.billingFrequencyConfig=null}static get observedAttributes(){return["data-theme","product-id","api-key","data-rate-plan-config","data-currency-config","data-billing-frequency-config"]}connectedCallback(){this.productId=this.getAttribute("product-id"),this.apiKey=this.getAttribute("api-key");const e=this.getAttribute("data-theme");if(e)try{const i=JSON.parse(e);this.theme=i}catch(i){console.error("Error parsing data-theme:",i)}const r=this.getAttribute("data-rate-plan-config");if(r)try{this.ratePlanConfig=JSON.parse(r)}catch(i){console.error("Error parsing data-rate-plan-config:",i)}const t=this.getAttribute("data-currency-config");if(t)try{this.currencyConfig=JSON.parse(t)}catch(i){console.error("Error parsing data-currency-config:",i)}const a=this.getAttribute("data-billing-frequency-config");if(a)try{this.billingFrequencyConfig=JSON.parse(a)}catch(i){console.error("Error parsing data-billing-frequency-config:",i)}console.log("=== Pricing Cards Input Attributes ==="),console.log("product-id:",this.productId),console.log("api-key:",this.apiKey),console.log("theme:",this.theme),console.log("ratePlanConfig:",this.ratePlanConfig),console.log("currencyConfig:",this.currencyConfig),console.log("billingFrequencyConfig:",this.billingFrequencyConfig),console.log("====================================="),this.loadPlansFromApi()}async loadPlansFromApi(){this.isLoading=!0,this.apiError=null,this.renderLoadingState();try{const e=`${c.baseUrl}/products/${this.productId}/pricing-table`;console.log("Fetching pricing data from:",e);const r=await fetch(e,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":this.apiKey}});if(!r.ok)throw new Error(`HTTP error! status: ${r.status}`);const t=await r.json();console.log("API Response:",t),this.allPlans=this.mergeApiDataWithTheme(t),this.setupPeriodFiltering(),this.isLoading=!1,this.isCheckout?this.loadPlanSelectorComponent().then(()=>{this.render()}).catch(a=>{console.error("Error loading plan-selector, falling back to buttons:",a),this.isCheckout=!1,this.render()}):this.render()}catch(e){console.error("Error fetching pricing data:",e),this.apiError=e.message,this.isLoading=!1,this.allPlans=[],this.renderErrorState()}}loadPlanSelectorComponent(){if(customElements.get("plan-selector"))return Promise.resolve();const e=document.querySelector('script[data-component="plan-selector"]');if(e)return new Promise(i=>{e.dataset.loaded==="true"?i():e.addEventListener("load",i)});const r=["./dist/web-components/plan-selector.min.js","../dist/web-components/plan-selector.min.js","/dist/web-components/plan-selector.min.js","dist/web-components/plan-selector.min.js"],t=document.currentScript||document.querySelector('script[src*="pricing-cards"]');let a=r[0];return t&&t.src&&(a=`${t.src.substring(0,t.src.lastIndexOf("/"))}/plan-selector.min.js`),new Promise((i,l)=>{const n=document.createElement("script");n.src=a,n.dataset.component="plan-selector",n.dataset.loaded="false",n.onload=()=>{n.dataset.loaded="true",console.log("Plan-selector component loaded successfully"),i()},n.onerror=()=>{console.error(`Failed to load plan-selector component from: ${a}`),l(new Error("Failed to load plan-selector component"))},document.head.appendChild(n)})}attributeChangedCallback(e,r,t){if(r!==t){if(console.log("attribute changed :",e,t),e==="data-theme")try{console.log("Theme attribute changed, reloading config..."),this.loadConfiguration(),this.plans.length>0&&this.render();return}catch(a){console.error("Error parsing data-theme:",a)}else if(e==="data-rate-plan-config")try{this.ratePlanConfig=JSON.parse(t)}catch(a){console.error("Error parsing data-rate-plan-config:",a)}else if(e==="data-currency-config")try{this.currencyConfig=JSON.parse(t)}catch(a){console.error("Error parsing data-currency-config:",a)}else if(e==="data-billing-frequency-config")try{this.billingFrequencyConfig=JSON.parse(t)}catch(a){console.error("Error parsing data-billing-frequency-config:",a)}this.isCheckout?this.loadPlanSelectorComponent().then(()=>{this.render()}).catch(a=>{console.error("Error loading plan-selector, falling back to buttons:",a),this.isCheckout=!1,this.render()}):this.render()}}mergeApiDataWithTheme(e){if(!e||!Array.isArray(e))throw new Error("Invalid API data structure: expected an array");if(console.log("=== Merging API Data with Theme ==="),console.log("API Data:",e),console.log("Rate Plan Config:",this.ratePlanConfig),!this.ratePlanConfig||!Array.isArray(this.ratePlanConfig))return console.log("No rate plan config to merge"),e.sort((t,a)=>(t.planLevel||0)-(a.planLevel||0));const r=e.map(t=>{const a=this.ratePlanConfig.find(i=>i.ratePlanId===t.ratePlanId);return a?(console.log(`Merging plan ${t.ratePlanPriceId}:`,{apiPlan:t,matchingConfig:a}),{...t,...a}):t});return console.log("Merged Plans Result:",r),r.sort((t,a)=>(t.planLevel||0)-(a.planLevel||0))}setupPeriodFiltering(){const e=new Map;this.allPlans.forEach(r=>{var i,l;const t=(i=r.billingPeriod)==null?void 0:i.id,a=(l=r.billingPeriod)==null?void 0:l.periodName;t&&a&&e.set(t,a)}),this.availablePeriods=Array.from(e.entries()).map(([r,t])=>({id:r,name:t})),this.selectedPeriod=this.availablePeriods.length>0?this.availablePeriods[0].id:null,this.filterPlansByPeriod()}filterPlansByPeriod(){this.selectedPeriod?this.plans=this.allPlans.filter(e=>{var r;return((r=e.billingPeriod)==null?void 0:r.id)===this.selectedPeriod}):this.plans=this.allPlans}handlePeriodChange(e){this.selectedPeriod=e,this.filterPlansByPeriod(),this.render()}getCurrencySymbol(e){return{USD:"$",EUR:"€",GBP:"£",INR:"₹",JPY:"¥",CAD:"C$",AUD:"A$",CHF:"CHF",CNY:"¥",SEK:"kr",NZD:"NZ$",MXN:"$",SGD:"S$",HKD:"HK$",NOK:"kr",TRY:"₺",RUB:"₽",BRL:"R$",ZAR:"R",KRW:"₩"}[e==null?void 0:e.toUpperCase()]||e||"$"}renderLoadingState(){this.shadowRoot.innerHTML=`
    ...
    `}handlePlanSelect(e){const r=new CustomEvent("plan-selected",{detail:{selectedPlan:e},bubbles:!0});this.dispatchEvent(r)}render(){var r;console.log("render function");const e=((r=this.theme.layout)==null?void 0:r.mode)==="grid";console.log("config check :",this.theme,e),this.shadowRoot.innerHTML=`
      ${this.getStyles()}
      <div class="pricing-display">
    ...
    `}renderPlan(e){var r,t;if(((r=this.theme.layout)==null?void 0:r.mode)==="card"){const a=`<svg class="feature-check-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      `}else return""}getStyles(){var a,i,l,n,s,h,b,f,g,p,v,m,u,y,x,w,$;console.log("getStyles :",this.theme);const e=((i=(a=this.theme.card)==null?void 0:a.style)==null?void 0:i.shadow)||"0 2px 8px rgba(0, 0, 0, 0.08)",r=((n=(l=this.theme.card)==null?void 0:l.style)==null?void 0:n.borderColor)||"#dbdfea";(h=(s=this.theme.card)==null?void 0:s.style)!=null&&h.spacing;const t=((f=(b=this.theme.card)==null?void 0:b.layout)==null?void 0:f.columns)||4;return`
      <style>

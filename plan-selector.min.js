(function(){"use strict";const m={baseUrl:"http://localhost:4001",apiKey:"7e4272f5dc4a2b44442910b1196bf402b09617f9d7a4c1db936583a9008a9fd7",productId:"cf190aae-cf47-44b0-9e11-6aa6f26bc403",endpoints:{pricingTable:f=>`/products/${f}/pricing-table`,products:"/products",subscriptions:"/subscriptions"},headers:{"Content-Type":"application/json",Accept:"application/json"},getAuthHeaders(){return{...this.headers,"api-key":this.apiKey}},getPricingTableUrl(f=null){const e=f||this.productId;return`${this.baseUrl}${this.endpoints.pricingTable(e)}`}};typeof module<"u"&&module.exports&&(module.exports=m),typeof window<"u"&&(window.ApiConfig=m);const y={accentColor:"#5b5bd6",headerColor:"#ffffff",highlightPanelColor:"#f7f7fe",cardsColor:"#ffffff",inputComponentsColor:"#f9fafb",fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",fontSizeHeading:"1.275rem",fontSizeSubHeading:"1.25rem",fontSizeBodyText:"0.9375rem",fontSizeSubText:"0.875rem",fontSizeFootNotes:"0.8125rem",headerFontWeight:"700",elementBorderRadius:"4px",modalBorderRadius:"8px",textColor:"#111827",subTextColor:"#6b7280",errorColor:"#dc2626",successColor:"#10b981",warningColor:"#f59e0b",loadingColor:"#f9fafb",disabledColor:"#f3f4f6",cardShadow:"0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",modalShadow:"0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)"};function x(f=y){return`
    :host {
      ${Object.entries(f).map(([t,i])=>`${`--billhive-${t.replace(/([A-Z])/g,"-$1").toLowerCase()}`}: ${i};`).join(`
    `)}
    }
  `}function k(f={}){return{...y,...f}}function w(f){const e=f.replace("#",""),t=parseInt(e.substr(0,2),16),i=parseInt(e.substr(2,2),16),o=parseInt(e.substr(4,2),16),r=Math.floor(t*.8),l=Math.floor(i*.8),p=Math.floor(o*.8);return{accentHover:`#${r.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}${p.toString(16).padStart(2,"0")}`,accentLight:`rgba(${t}, ${i}, ${o}, 0.1)`,buttonShadow:`0 2px 4px rgba(${t}, ${i}, ${o}, 0.3)`}}function D(f){const e=[];return["accentColor","fontFamily","textFontSize"].forEach(o=>{f[o]||e.push(`Missing required theme property: ${o}`)}),["accentColor","headerColor","highlightPanelColor","cardsColor"].forEach(o=>{f[o]&&!f[o].match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/)&&e.push(`Invalid hex color format for ${o}: ${f[o]}`)}),{isValid:e.length===0,errors:e}}class C extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.selectedPlan=null,this.planId=null,this.isLoadingPlan=!1,this.planLoadError=null,this.addons=[],this.selectedAddons=new Set,this.addonQuantities=new Map,this.isLoadingAddons=!1,this.addonsLoadError=null,this.isVisible=!1,this.couponCode="",this.appliedCoupon=null,this.availableDiscounts=[],this.selectedDiscount=null,this.isLoadingOffers=!1,this.offersLoadError=null,this.updateTimeout=null,this.orderEstimate=null,this.isLoadingEstimate=!1,this.estimateError=null,this.estimateRequestId=0,this.currentModalStep="plan-selection",this.existingAccount=null,this.isCheckingExistingAccount=!1,this.createdOrder=null,this.isCreatingOrder=!1,this.orderCreated=!1,this.orderInvoices=[],this.isLoadingInvoices=!1,this.personalDetails={firstName:"",lastName:"",email:"",phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},this.formErrors={},this.selectedPaymentMethod="",this.orderData=null,this.paymentDetails={card:{cardNumber:"",expiryDate:"",cvv:"",cardholderName:""},upi:{upiId:""},netbanking:{bankName:""},wallet:{walletType:"",walletNumber:""}},this.theme=y,this.cashfreeInstance=null,this.cashfreeComponents={cardNumber:null,cardHolder:null,cardExpiry:null,cardCvv:null,upiCollect:null,wallets:new Map}}static get observedAttributes(){return["data-plan","data-plan-id","visible","data-theme"]}connectedCallback(){this.loadData(),this.loadCashfreeSDK(),this.render(),this.setupEventListeners()}async loadCashfreeSDK(){try{if(window.Cashfree){console.log("Cashfree SDK already loaded globally"),this.cashfreeInstance=window.Cashfree;return}const e=document.createElement("script");e.src="https://sdk.cashfree.com/js/v3/cashfree.js",e.async=!0,await new Promise((t,i)=>{e.onload=()=>{console.log("Cashfree SDK script loaded"),window.Cashfree?(this.cashfreeInstance=new window.Cashfree({mode:"sandbox"}),console.log("✅ Cashfree SDK initialized successfully"),t()):i(new Error("Cashfree object not found after script load"))},e.onerror=i,document.head.appendChild(e)})}catch(e){console.error("❌ Failed to load Cashfree SDK:",e)}}attributeChangedCallback(e,t,i){t!==i&&(e==="data-plan"?this.loadPlan():e==="data-plan-id"?this.planId=i:e==="visible"?this.isVisible=i==="true":e==="data-theme"&&this.loadTheme(),this.render())}loadData(){this.planId=this.getAttribute("data-plan-id"),this.planId||(this.loadPlan(),this.addons=[]),this.isVisible=this.getAttribute("visible")==="true",this.loadTheme()}loadTheme(){this.theme={...y};const e=w(this.theme.accentColor);this.theme={...this.theme,...e},console.log("PlanSelector theme loaded:",this.theme);const t=this.getAttribute("data-theme");if(t)try{const i=JSON.parse(t),o=D(i);if(o.isValid){if(this.theme=k(i),i.accentColor){const r=w(i.accentColor);this.theme={...this.theme,...r}}console.log("PlanSelector custom theme applied:",this.theme)}else console.warn("Invalid theme configuration:",o.errors)}catch(i){console.warn("Invalid JSON in data-theme attribute:",i)}}loadPlan(){const e=this.getAttribute("data-plan");if(e)try{this.selectedPlan=JSON.parse(e)}catch{this.selectedPlan=null}else this.selectedPlan={id:"professional",name:"Professional",description:"Perfect for growing businesses",price:49,period:"month",features:["Unlimited invoices","Up to 10 team members","Advanced analytics","Priority support","API access"]}}async loadPlanFromApi(){var e,t;if(this.planId){this.isLoadingPlan=!0,this.planLoadError=null;try{const i=((e=window.ApiConfig)==null?void 0:e.baseUrl)||m.baseUrl,o=((t=window.ApiConfig)==null?void 0:t.apiKey)||m.apiKey,r=`${i}/rate-plan-prices/${this.planId}`,l=await fetch(r,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":o}});if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);const p=await l.json();this.selectedPlan=this.transformPlanApiData(p),this.isLoadingPlan=!1,this.planLoadError=null,this.render(),this.loadAddonsFromApi().catch(c=>{console.error("Failed to load addons:",c)}),this.loadApplicableOffers().catch(c=>{console.error("Failed to load applicable offers:",c)}),this.updateOrderSummary()}catch(i){this.planLoadError=i.message,this.isLoadingPlan=!1,this.isLoadingAddons=!1,this.loadPlan(),this.addons=[],this.render()}}}transformPlanApiData(e){var i,o,r;return{id:e.ratePlanId,ratePlanPriceId:e.ratePlanPriceId,name:e.name||e.externalName,description:e.description,price:e.price,currencyCode:e.currencyCode,period:((i=e.billingPeriod)==null?void 0:i.periodName)||((o=e.billingPeriod)==null?void 0:o.period),periodName:(r=e.billingPeriod)==null?void 0:r.periodName,billingPeriod:e.billingPeriod,features:e.addons||e.features||[],recommended:e.mostPopular||!1,planLevel:e.planLevel,isTrial:e.isTrial,trialPeriod:e.trialPeriod,ratePlanKey:e.ratePlanKey,productName:e.productName,productId:e.productId,status:e.status,isVisibleInPortal:e.isVisibleInPortal,isVisibleInCheckout:e.isVisibleInCheckout,requireBillingAtSignup:e.requireBillingAtSignup,autoRenew:e.autoRenew,termLength:e.termLength,taxIncluded:e.taxIncluded,pricingModel:e.pricingModel,billingCycle:e.billingCycle}}async loadAddonsFromApi(){var e,t,i;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){this.addons=[];return}this.isLoadingAddons=!0,this.addonsLoadError=null;try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=encodeURIComponent('{"where":{"applicability":{"neq":"Mandatory"}}}'),p=`${o}/rate-plan-prices/${this.selectedPlan.ratePlanPriceId}/addons?filter=${l}`,c=await fetch(p,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r}});if(!c.ok)throw new Error(`Failed to fetch addons: HTTP ${c.status}`);const a=await c.json();this.addons=this.transformAddonsApiData(a),this.isLoadingAddons=!1,this.addonsLoadError=null,this.render()}catch(o){console.error("Error loading addons:",o),this.addonsLoadError=o.message,this.isLoadingAddons=!1,this.addons=[],this.render()}}transformAddonsApiData(e){return Array.isArray(e)?e.map(t=>{var i,o;return{id:t.addonPriceId,addonId:t.addonId,addonPriceId:t.addonPriceId,name:t.externalName||t.name,description:t.description,price:t.price,quantity:t.quantity||1,unitOfMeasurement:t.unitOfMeasurement,period:(o=(i=t.billingPeriod)==null?void 0:i.periodName)==null?void 0:o.toLowerCase(),billingPeriod:t.billingPeriod,currencyCode:t.currencyCode,pricingModel:t.pricingModel,applicability:t.applicability,isPriceIncluded:t.isPriceIncluded,isVisibleInPortal:t.isVisibleInPortal,status:t.status,addonPriceKey:t.addonPriceKey}}):[]}async loadApplicableOffers(){var e,t,i;if(!((e=this.selectedPlan)!=null&&e.ratePlanPriceId)){console.warn("No ratePlanPriceId available to load offers"),this.availableDiscounts=[];return}this.isLoadingOffers=!0,this.offersLoadError=null,this.render();try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=`${o}/applicable-offers`,p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r},body:JSON.stringify({ratePlanPriceId:this.selectedPlan.ratePlanPriceId})});if(!p.ok)throw new Error(`Failed to fetch applicable offers: HTTP ${p.status}`);const c=await p.json();this.availableDiscounts=c.map(a=>{var s;return{id:a.id,name:a.externalName||a.name,description:a.description,type:a.discountType==="Percentage"?"percentage":"fixed",value:a.amount,code:((s=a.code)==null?void 0:s.trim())||`OFFER${a.id.slice(-8).toUpperCase()}`,apiData:{tenantId:a.tenantId,applyOn:a.applyOn,discountDurationType:a.discountDurationType,expiryDate:a.expiryDate,maxRedemptionCount:a.maxRedemptionCount,maxRedemptionCountPerCustomer:a.maxRedemptionCountPerCustomer,minimumPurchaseAmount:a.minimumPurchaseAmount,status:a.status}}}).filter(a=>a.apiData.status==="Active"),this.isLoadingOffers=!1,this.offersLoadError=null}catch(o){console.error("Error loading applicable offers:",o),this.isLoadingOffers=!1,this.offersLoadError=o.message,this.availableDiscounts=[]}this.render()}async loadOrderEstimate(){var t,i;this.estimateRequestId+=1;const e=this.estimateRequestId;this.isLoadingEstimate=!0,this.estimateError=null,this.orderEstimate=null,this.render();try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=`${o}/orders/estimate`,p=this.buildEstimateRequestBody(),c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r},body:JSON.stringify(p)});if(e!==this.estimateRequestId)return;if(!c.ok)throw new Error(`Failed to fetch order estimate: HTTP ${c.status}`);const a=await c.json();console.log("Order estimate received:",a),e===this.estimateRequestId&&(this.orderEstimate=a,this.isLoadingEstimate=!1,this.estimateError=null)}catch(o){e===this.estimateRequestId&&(console.error("Error loading order estimate:",o),this.isLoadingEstimate=!1,this.estimateError=o.message,this.orderEstimate=null)}e===this.estimateRequestId&&this.render()}buildEstimateRequestBody(){var o;const e=[],t=new Date().toISOString().split("T")[0];return this.selectedPlan&&(e.push({itemType:"Rate Plan",itemId:this.selectedPlan.ratePlanPriceId,quantity:1,options:{startDate:t,billingCycle:1,autoRenew:!1,autoCollect:!1,invoiceGenerationPreference:"Immediately"}}),this.selectedAddons.forEach(r=>{const l=this.addons.find(p=>p.id===r);l&&e.push({itemType:"Addon",itemId:l.addonPriceId,quantity:this.addonQuantities.get(r)||1,options:{ratePlanPriceId:this.selectedPlan.ratePlanPriceId}})})),this.selectedDiscount&&e.push({itemType:"Discount",itemId:this.selectedDiscount.id,quantity:1}),console.log("Applied coupon is:",this.appliedCoupon),this.appliedCoupon&&e.push({itemType:"Coupon",itemId:this.appliedCoupon.code,quantity:1,options:{startDate:t}}),{srcSysCode:"Website",eventType:"NEW SUBSCRIPTION",currency:(o=this.selectedPlan)==null?void 0:o.currencyCode,scheduleDate:t,cart:e,personalInfo:{}}}buildPlaceOrderRequestBody(e){const t=this.buildEstimateRequestBody();return t.personalInfo={accountId:e},t}async placeOrder(e){var t,i;if(this.orderCreated)return console.log("Order already created, skipping duplicate creation"),this.createdOrder;if(this.isCreatingOrder){console.log("Order creation in progress, skipping duplicate request");return}try{this.isCreatingOrder=!0;const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=`${o}/orders/place`,p=this.buildPlaceOrderRequestBody(e);console.log("Placing order with request body:",p);const c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r},body:JSON.stringify(p)});if(!c.ok)throw new Error(`Failed to place order: HTTP ${c.status}`);const a=await c.json();return console.log("Order placed successfully:",a),this.createdOrder=a,this.orderCreated=!0,this.isCreatingOrder=!1,a}catch(o){throw console.error("Error placing order:",o),this.isCreatingOrder=!1,o}}async getOrderInvoices(e){var t,i;if(!e){console.error("Order ID is required to fetch invoices");return}if(this.isLoadingInvoices){console.log("Invoices loading in progress, skipping duplicate request");return}try{this.isLoadingInvoices=!0;const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=encodeURIComponent(JSON.stringify({where:{status:"Posted",orderId:e}})),p=`${o}/invoices?filter=${l}`;console.log("Fetching invoices for order:",e);const c=await fetch(p,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r}});if(!c.ok)throw new Error(`Failed to fetch invoices: HTTP ${c.status}`);const a=await c.json();return console.log("Invoices fetched successfully:",a),this.orderInvoices=a,this.isLoadingInvoices=!1,a}catch(o){throw console.error("Error fetching invoices:",o),this.isLoadingInvoices=!1,this.orderInvoices=[],o}}async updateAccount(e){var t,i,o,r;try{const l=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,p=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,c=`${l}/accounts/${e}`,a={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1},s=await fetch(c,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":p},body:JSON.stringify(a)});if(!s.ok)throw new Error(`Failed to update account: HTTP ${s.status}`);let d;return s.status===204?(console.log("Customer account updated successfully (204 No Content)"),d={...this.existingAccount,accountId:e,name:a.name,country:a.country,address:a.address,state:a.state,city:a.city,zipCode:a.zipCode,phone:a.phone,email:a.email,accountType:a.accountType,communicationProfile:this.existingAccount.communicationProfile}):(d=await s.json(),console.log("Customer account updated:",d)),a.accountType==="Organisation"&&((r=(o=this.existingAccount)==null?void 0:o.communicationProfile)!=null&&r.contactId)&&await this.updateContact(e,this.existingAccount.communicationProfile.contactId),d}catch(l){throw console.error("Error updating account:",l),l}}async updateContact(e,t){var i,o,r,l,p,c;try{const a=((i=window.ApiConfig)==null?void 0:i.baseUrl)||m.baseUrl,s=((o=window.ApiConfig)==null?void 0:o.apiKey)||m.apiKey,d=`${a}/accounts/${e}/contacts/${t}`,n={fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,email:this.personalDetails.email,address:this.personalDetails.address.addressLine,billNotification:(l=(r=this.existingAccount)==null?void 0:r.communicationProfile)==null?void 0:l.billNotification,accountNotification:(c=(p=this.existingAccount)==null?void 0:p.communicationProfile)==null?void 0:c.accountNotification,phone:this.personalDetails.phone};console.log("Updating contact:",t,n);const h=await fetch(d,{method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":s},body:JSON.stringify(n)});if(!h.ok)throw new Error(`Failed to update contact: HTTP ${h.status}`);if(h.status===204)return console.log("Contact updated successfully (204 No Content)"),{success:!0};const u=await h.json();return console.log("Contact updated:",u),u}catch(a){throw console.error("Error updating contact:",a),a}}async createCustomerAccount(){var e,t;try{if(this.existingAccount&&this.existingAccount.accountId){console.log("Updating existing Draft account:",this.existingAccount);const a=await this.updateAccount(this.existingAccount.accountId);return this.createdAccountId=a.id||a.accountId,a}const i=((e=window.ApiConfig)==null?void 0:e.baseUrl)||m.baseUrl,o=((t=window.ApiConfig)==null?void 0:t.apiKey)||m.apiKey,r=`${i}/accounts`,l={accountType:this.personalDetails.company&&this.personalDetails.company.trim()?"Organisation":"Individual",name:this.personalDetails.company&&this.personalDetails.company.trim()?this.personalDetails.company.trim():`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),country:this.personalDetails.address.country,address:this.personalDetails.address.addressLine,state:this.personalDetails.address.state,city:this.personalDetails.address.city,zipCode:this.personalDetails.address.zipCode,phone:this.personalDetails.phone,email:this.personalDetails.email,sameAsSoldTo:!1,communicationProfile:{fullName:`${this.personalDetails.firstName} ${this.personalDetails.lastName}`.trim(),address:this.personalDetails.address.addressLine,country:this.personalDetails.address.country,phone:this.personalDetails.phone,email:this.personalDetails.email}},p=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":o},body:JSON.stringify(l)});if(!p.ok)throw new Error(`Failed to create customer account: HTTP ${p.status}`);const c=await p.json();return console.log("Customer account created:",c),this.createdAccountId=c.accountId,c}catch(i){throw console.error("Error creating customer account:",i),i}}async checkExistingAccount(e){var t,i;try{const o=((t=window.ApiConfig)==null?void 0:t.baseUrl)||m.baseUrl,r=((i=window.ApiConfig)==null?void 0:i.apiKey)||m.apiKey,l=`${o}/accounts?filter=${encodeURIComponent(JSON.stringify({where:{email:e}}))}`,p=await fetch(l,{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json","x-api-key":r}});if(!p.ok)throw new Error(`Failed to check existing account: HTTP ${p.status}`);const c=await p.json();return console.log("Existing account check result:",c),c.accounts&&c.accounts.length>0?c.accounts[0]:null}catch(o){return console.error("Error checking existing account:",o),null}}async handleEmailCheck(e){if(console.log("Checking email:",e),this.isCheckingExistingAccount){console.log("Already checking, skipping...");return}this.isCheckingExistingAccount=!0,this.existingAccount=null,this.hideExistingAccountMessage(),delete this.formErrors.email,this.updateFieldError("email");try{const t=await this.checkExistingAccount(e);console.log("Found existing account:",t),t&&t.accountId?t.status==="Active"?(console.log("Account is Active, showing error"),this.formErrors.email="Email ID is already associated with another account, please use another email ID",this.updateFieldError("email"),this.updateNextButtonState()):t.status==="Draft"&&(console.log("Account is Draft, prefilling details"),t&&(this.existingAccount=t,this.showExistingAccountMessage(t),await this.prefillAccountDetails(t))):(console.log("No existing account found"),this.hideExistingAccountMessage())}catch(t){console.error("Error during email check:",t)}finally{this.isCheckingExistingAccount=!1}}async prefillAccountDetails(e){console.log("Prefilling account details:",e),console.log("Current personal details before prefill:",this.personalDetails);const t=this.personalDetails.email;if(this.personalDetails={firstName:"",lastName:"",email:t,phone:"",company:"",address:{addressLine:"",city:"",state:"",zipCode:"",country:""}},e.accountType==="Organisation"){if(console.log("Organisation account detected"),this.personalDetails.company=e.name,console.log("Prefilled company:",this.personalDetails.company),e.communicationProfile&&e.communicationProfile.fullName){const i=e.communicationProfile.fullName.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName from communicationProfile:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName from communicationProfile:",this.personalDetails.lastName))}}else if(console.log("Individual account detected"),e.name){const i=e.name.split(" ").filter(o=>o.trim());i.length>=1&&(this.personalDetails.firstName=i[0],console.log("Prefilled firstName:",this.personalDetails.firstName)),i.length>=2&&(this.personalDetails.lastName=i.slice(1).join(" "),console.log("Prefilled lastName:",this.personalDetails.lastName))}e.phone&&(this.personalDetails.phone=e.phone,console.log("Prefilled phone:",this.personalDetails.phone)),e.address&&(this.personalDetails.address.addressLine=e.address,console.log("Prefilled addressLine:",this.personalDetails.address.addressLine)),e.city&&(this.personalDetails.address.city=e.city,console.log("Prefilled city:",this.personalDetails.address.city)),e.state&&(this.personalDetails.address.state=e.state,console.log("Prefilled state:",this.personalDetails.address.state)),e.zipCode&&(this.personalDetails.address.zipCode=e.zipCode,console.log("Prefilled zipCode:",this.personalDetails.address.zipCode)),e.country&&(this.personalDetails.address.country=e.country,console.log("Prefilled country:",this.personalDetails.address.country)),console.log("Personal details after prefill:",this.personalDetails),this.render(),this.updateNextButtonState()}showExistingAccountMessage(e){const t=this.shadowRoot.querySelector('[data-field="email"]');if(t){let i=this.shadowRoot.querySelector(".existing-account-message");i||(i=document.createElement("div"),i.className="existing-account-message",t.parentNode.appendChild(i)),i.innerHTML=`
    ...
    `}renderOrderSummary(){if(!this.selectedPlan)return"<p>No plan selected</p>";if(this.isLoadingEstimate)return`
      ...
      `;const e=this.orderEstimate,t=this.getCurrencySymbol(e.currency||this.selectedPlan.currencyCode);let i="";const o=[],r=[],l=new Map;let p=null;if(e.cart&&e.cart.length>0&&e.cart.forEach(a=>{var d,n;if(!((a.itemType==="Discount"||a.itemType==="Coupon"||(d=a.description)!=null&&d.toLowerCase().includes("coupon")||(n=a.description)!=null&&n.toLowerCase().includes("discount"))&&a.status==="Rejected"))if(a.itemType==="Rate Plan"&&a.status==="Reserved"&&a.nextBillingDate&&(p=this.formatDisplayDate(a.nextBillingDate)),a.itemType==="Discount"&&a.itemId&&a.status!=="Reserved"){l.has(a.itemId)||l.set(a.itemId,{description:a.description,items:[],totalAmount:0});const h=l.get(a.itemId);h.items.push(a),h.totalAmount+=a.amount}else a.status==="Reserved"?r.push(a):o.push(a)}),o.forEach(a=>{var u,v;const s=a.itemType==="Discount"||a.itemType==="Coupon"||((u=a.description)==null?void 0:u.toLowerCase().includes("coupon"))||((v=a.description)==null?void 0:v.toLowerCase().includes("discount"));if(a.itemType==="Discount")return;const d=a.fromDate&&!s?this.formatDisplayDate(a.fromDate):"",n=a.toDate&&!s?this.formatDisplayDate(a.toDate):"",h=d&&n?`${d} - ${n}`:"";i+=`
        <div class="summary-item">
          <div class="item-details">
            <span class="item-name">${a.description}</span>
            ${h?`<span class="item-dates">${h}</span>`:""}
          </div>
          <span class="item-price ${s?"discount-price":""}">
            ${s?"-":""}${t}${a.amount.toFixed(2)}
          </span>
        </div>
      `}),l.forEach((a,s)=>{const d=a.items.length>1;i+=`
        <div class="summary-item discount-group">
          <div class="item-details">
            <span class="item-name">
              ${a.description}
              ${d?`
                <span class="discount-info-icon" data-discount-id="${s}">
                  ⓘ
                  <div class="discount-tooltip">
                    <div class="tooltip-title">Applied on:</div>
                    ${a.items.map(n=>{var u;return`<div class="tooltip-item">- ${((u=n.options)==null?void 0:u.itemType)||"Item"}: ${t}${n.amount.toFixed(2)}</div>`}).join("")}
                  </div>
                </span>
              `:""}
            </span>
      ...
      `}),r.length>0){const a=new Map,s=[];r.forEach(n=>{if(n.itemType==="Discount"&&n.itemId){a.has(n.itemId)||a.set(n.itemId,{description:n.description,items:[],totalAmount:0});const h=a.get(n.itemId);h.items.push(n),h.totalAmount+=n.amount}else s.push(n)});const d=r.reduce((n,h)=>n+h.amount,0);i+=`
        <div class="reserved-items-section">
          ${p?`
            <div class="reserved-billing-date">
              Next Billing Date - <span class="billing-date-value">${p}</span>
            </div>
          `:""}
          
          ${s.map(n=>{var b,P;const h=n.itemType==="Discount"||n.itemType==="Coupon"||((b=n.description)==null?void 0:b.toLowerCase().includes("coupon"))||((P=n.description)==null?void 0:P.toLowerCase().includes("discount")),u=n.fromDate&&!h?this.formatDisplayDate(n.fromDate):"",v=n.toDate&&!h?this.formatDisplayDate(n.toDate):"",g=u&&v?`${u} - ${v}`:"";return`
              <div class="summary-item reserved-item">
                <div class="item-details">
                  <span class="item-name">${n.description}</span>
                  ${g?`<span class="item-dates">${g}</span>`:""}
                </div>
                <span class="item-price ${h?"discount-price":""}">
                  ${h?"-":""}${t}${n.amount.toFixed(2)}
                </span>
              </div>
            `}).join("")}
          
          ${Array.from(a.entries()).map(([n,h])=>{const u=h.items.length>1;return`
              <div class="summary-item reserved-item discount-group">
                <div class="item-details">
                  <span class="item-name">
                    ${h.description}
                    ${u?`
                      <span class="discount-info-icon" data-discount-id="${n}">
                        ⓘ
                        <div class="discount-tooltip">
                          <div class="tooltip-title">Applied on:</div>
          ...
          <div class="reserved-subtotal">
            ...
            <span class="subtotal-price">${t}${d.toFixed(2)}</span>
          </div>
        </div>
      `}i+=`
    ...
    `;const c=e.discounts?e.discounts.reduce((a,s)=>a+s.amount,0):0;return c>0&&(i+=`
      ...
      <style>
        ...
        .modal-container {
          ...
          overflow: hidden;
          box-shadow: var(--billhive-modal-shadow, 0 0.5rem 1rem rgba(0, 0, 0, 0.15));
          position: relative;
          margin: 0.5rem;
        }
    ...
    `}}customElements.define("plan-selector",C),typeof module<"u"&&module.exports&&(module.exports=C)})();
